...
(function(MoveDirection3) {
  MoveDirection3["bottom"] = "bottom";
  MoveDirection3["bottomLeft"] = "bottom-left";
  MoveDirection3["bottomRight"] = "bottom-right";
  MoveDirection3["left"] = "left";
  MoveDirection3["none"] = "none";
  MoveDirection3["right"] = "right";
  MoveDirection3["top"] = "top";
  MoveDirection3["topLeft"] = "top-left";
  MoveDirection3["topRight"] = "top-right";
  MoveDirection3["outside"] = "outside";
  MoveDirection3["inside"] = "inside";
...
function getDistances(pointA, pointB) {
  const dx = pointA.x - pointB.x, dy = pointA.y - pointB.y, squareExp6 = 2;
  return { dx, dy, distance: Math.sqrt(dx ** squareExp6 + dy ** squareExp6) };
}
...
var AnimationMode;
(function(AnimationMode3) {
  AnimationMode3["auto"] = "auto";
  AnimationMode3["increase"] = "increase";
  AnimationMode3["decrease"] = "decrease";
  AnimationMode3["random"] = "random";
})(AnimationMode || (AnimationMode = {}));

// node_modules/@tsparticles/engine/browser/Enums/AnimationStatus.js
var AnimationStatus;
(function(AnimationStatus3) {
  AnimationStatus3["increasing"] = "increasing";
  AnimationStatus3["decreasing"] = "decreasing";
})(AnimationStatus || (AnimationStatus = {}));

// node_modules/@tsparticles/engine/browser/Enums/Types/DestroyType.js
var DestroyType;
(function(DestroyType3) {
  DestroyType3["none"] = "none";
  DestroyType3["max"] = "max";
  DestroyType3["min"] = "min";
})(DestroyType || (DestroyType = {}));

// node_modules/@tsparticles/engine/browser/Enums/Directions/OutModeDirection.js
var OutModeDirection;
(function(OutModeDirection3) {
  OutModeDirection3["bottom"] = "bottom";
  OutModeDirection3["left"] = "left";
  OutModeDirection3["right"] = "right";
  OutModeDirection3["top"] = "top";
})(OutModeDirection || (OutModeDirection = {}));

// node_modules/@tsparticles/engine/browser/Enums/Modes/PixelMode.js
var PixelMode;
(function(PixelMode3) {
  PixelMode3["precise"] = "precise";
  PixelMode3["percent"] = "percent";
})(PixelMode || (PixelMode = {}));

// node_modules/@tsparticles/engine/browser/Enums/Types/StartValueType.js
var StartValueType;
(function(StartValueType3) {
  StartValueType3["max"] = "max";
  StartValueType3["min"] = "min";
  StartValueType3["random"] = "random";
...
function initParticleNumericAnimationValue(options, pxRatio) {
  ...
  if (animationOptions.enable) {
    res.decay = decayOffset3 - getRangeValue(animationOptions.decay);
...
function updateAnimation(particle, data, changeDirection, destroyType, delta) {
  const minLoops2 = 0, minDelay = 0, identity9 = 1, minVelocity9 = 0, minDecay = 1;
  if (particle.destroyed || !data || !data.enable || (data.maxLoops ?? minLoops2) > minLoops2 && (data.loops ?? minLoops2) > (data.maxLoops ?? minLoops2)) {
    return;
  }
  const velocity = (data.velocity ?? minVelocity9) * delta.factor, minValue = data.min, maxValue = data.max, decay = data.decay ?? minDecay;
  if (!data.time) {
    data.time = 0;
  }
  ...
  if (data.velocity && decay !== identity9) {
    data.velocity *= decay;
  }
...
var AlterType;
(function(AlterType3) {
  AlterType3["darken"] = "darken";
  AlterType3["enlighten"] = "enlighten";
})(AlterType || (AlterType = {}));
...
function updateColorValue(data, range, decrease, delta) {
  const minLoops2 = 0, minDelay = 0, identity9 = 1, minVelocity9 = 0, minOffset = 0, velocityFactor = 3.6;
  ...
  const offset = data.offset ? randomInRange(data.offset) : minOffset, velocity = (data.velocity ?? minVelocity9) * delta.factor + offset * velocityFactor, decay = data.decay ?? identity9, max = getRangeMax(range), min = getRangeMin(range);
...
(function(InteractivityDetect3) {
  InteractivityDetect3["canvas"] = "canvas";
  InteractivityDetect3["parent"] = "parent";
  InteractivityDetect3["window"] = "window";
...
var EventType;
(function(EventType3) {
  EventType3["configAdded"] = "configAdded";
  EventType3["containerInit"] = "containerInit";
  EventType3["particlesSetup"] = "particlesSetup";
  EventType3["containerStarted"] = "containerStarted";
  EventType3["containerStopped"] = "containerStopped";
  EventType3["containerDestroyed"] = "containerDestroyed";
  EventType3["containerPaused"] = "containerPaused";
  EventType3["containerPlay"] = "containerPlay";
  EventType3["containerBuilt"] = "containerBuilt";
  EventType3["particleAdded"] = "particleAdded";
  EventType3["particleDestroyed"] = "particleDestroyed";
  EventType3["particleRemoved"] = "particleRemoved";
})(EventType || (EventType = {}));
...
var DivType;
(function(DivType3) {
  DivType3["circle"] = "circle";
  DivType3["rectangle"] = "rectangle";
})(DivType || (DivType = {}));
...
var ResponsiveMode;
(function(ResponsiveMode3) {
  ResponsiveMode3["screen"] = "screen";
  ResponsiveMode3["canvas"] = "canvas";
...
(function(ThemeMode3) {
  ThemeMode3["any"] = "any";
  ThemeMode3["dark"] = "dark";
  ThemeMode3["light"] = "light";
})(ThemeMode || (ThemeMode = {}));
...
var CollisionMode;
(function(CollisionMode3) {
  CollisionMode3["absorb"] = "absorb";
  CollisionMode3["bounce"] = "bounce";
  CollisionMode3["destroy"] = "destroy";
...
var OutMode;
(function(OutMode3) {
  OutMode3["bounce"] = "bounce";
  OutMode3["none"] = "none";
  OutMode3["out"] = "out";
  OutMode3["destroy"] = "destroy";
  OutMode3["split"] = "split";
})(OutMode || (OutMode = {}));
...
var LimitMode;
(function(LimitMode3) {
  LimitMode3["delete"] = "delete";
  LimitMode3["wait"] = "wait";
})(LimitMode || (LimitMode = {}));
...
var InteractorType;
(function(InteractorType3) {
  InteractorType3["external"] = "external";
  InteractorType3["particles"] = "particles";
...
var ParticleOutType;
(function(ParticleOutType3) {
  ParticleOutType3["normal"] = "normal";
  ParticleOutType3["inside"] = "inside";
  ParticleOutType3["outside"] = "outside";
...
var RangeType;
(function(RangeType3) {
  RangeType3["circle"] = "circle";
  RangeType3["rectangle"] = "rectangle";
})(RangeType || (RangeType = {}));
...
var Engine = class {
  ...
  async load(params) {
    ...
    if (oldIndex >= loadMinIndex) {
      const old = this.item(oldIndex), deleteCount3 = old ? one : none;
      if (old && !old.destroyed) {
        old.destroy(false);
      }
      items.splice(oldIndex, deleteCount3, newItem);
    } else {
      items.push(newItem);
    }
...
var RotateDirection;
(function(RotateDirection3) {
  RotateDirection3["clockwise"] = "clockwise";
  RotateDirection3["counterClockwise"] = "counter-clockwise";
  RotateDirection3["random"] = "random";
...
(function(GradientType3) {
  ...
  GradientType3["random"] = "random";
})(GradientType || (GradientType = {}));

// node_modules/@tsparticles/engine/browser/Enums/Types/EasingType.js
var EasingType;
(function(EasingType3) {
  EasingType3["easeInBack"] = "ease-in-back";
  EasingType3["easeInCirc"] = "ease-in-circ";
  EasingType3["easeInCubic"] = "ease-in-cubic";
  EasingType3["easeInLinear"] = "ease-in-linear";
  EasingType3["easeInQuad"] = "ease-in-quad";
  EasingType3["easeInQuart"] = "ease-in-quart";
  EasingType3["easeInQuint"] = "ease-in-quint";
  EasingType3["easeInExpo"] = "ease-in-expo";
  EasingType3["easeInSine"] = "ease-in-sine";
  EasingType3["easeOutBack"] = "ease-out-back";
  EasingType3["easeOutCirc"] = "ease-out-circ";
  EasingType3["easeOutCubic"] = "ease-out-cubic";
  EasingType3["easeOutLinear"] = "ease-out-linear";
  EasingType3["easeOutQuad"] = "ease-out-quad";
  EasingType3["easeOutQuart"] = "ease-out-quart";
  EasingType3["easeOutQuint"] = "ease-out-quint";
  EasingType3["easeOutExpo"] = "ease-out-expo";
  EasingType3["easeOutSine"] = "ease-out-sine";
  EasingType3["easeInOutBack"] = "ease-in-out-back";
  EasingType3["easeInOutCirc"] = "ease-in-out-circ";
  EasingType3["easeInOutCubic"] = "ease-in-out-cubic";
  EasingType3["easeInOutLinear"] = "ease-in-out-linear";
  EasingType3["easeInOutQuad"] = "ease-in-out-quad";
  EasingType3["easeInOutQuart"] = "ease-in-out-quart";
  EasingType3["easeInOutQuint"] = "ease-in-out-quint";
  EasingType3["easeInOutExpo"] = "ease-in-out-expo";
  EasingType3["easeInOutSine"] = "ease-in-out-sine";
...
var AbsorberInstance = class {
  ...
  attract(particle) {
    ...
    if (distance < this.size + particle.getRadius()) {
      const sizeFactor3 = particle.getRadius() * absorbFactor * container.retina.pixelRatio;
      if (this.size > particle.getRadius() && distance < this.size - particle.getRadius() || particle.absorberOrbit !== void 0 && particle.absorberOrbit.length < minOrbitLength) {
        ...
        if (options.destroy) {
          particle.size.value -= sizeFactor3;
        }
        this._updateParticlePosition(particle, v);
      }
      if (this.limit.radius <= minRadius || this.size < this.limit.radius) {
        this.size += sizeFactor3;
      }
      if (this.limit.mass <= minMass || this.mass < this.limit.mass) {
        this.mass += sizeFactor3 * this.options.size.density * container.retina.reduceFactor;
      }
    } else {
      this._updateParticlePosition(particle, v);
    }
...
var Absorbers = class {
  ...
  removeAbsorber(absorber) {
    const index = this.array.indexOf(absorber), deleteCount3 = 1;
    if (index >= defaultIndex) {
      this.array.splice(index, deleteCount3);
    }
  }
  resize() {
    for (const absorber of this.array) {
...
var Emitters = class {
  ...
  removeEmitter(emitter) {
    const index = this.array.indexOf(emitter), minIndex3 = 0, deleteCount3 = 1;
    if (index >= minIndex3) {
      this.array.splice(index, deleteCount3);
    }
  }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/Constants.js
var generatedAttribute2 = "generated";
var mouseDownEvent2 = "pointerdown";
var mouseUpEvent2 = "pointerup";
var mouseLeaveEvent2 = "pointerleave";
var mouseOutEvent2 = "pointerout";
var mouseMoveEvent2 = "pointermove";
var touchStartEvent2 = "touchstart";
var touchEndEvent2 = "touchend";
var touchMoveEvent2 = "touchmove";
var touchCancelEvent2 = "touchcancel";
var resizeEvent2 = "resize";
var visibilityChangeEvent2 = "visibilitychange";
var errorPrefix2 = "tsParticles - Error";
var percentDenominator2 = 100;
var half4 = 0.5;
var millisecondsToSeconds2 = 1e3;
var originPoint2 = {
  x: 0,
  y: 0,
  z: 0
};
var defaultTransform2 = {
  a: 1,
  b: 0,
  c: 0,
  d: 1
...
var defaultFps2 = 60;
var generatedTrue2 = "true";
var generatedFalse2 = "false";
var canvasTag2 = "canvas";
var defaultRetryCount2 = 0;
var squareExp4 = 2;
var qTreeCapacity2 = 4;
var defaultRemoveQuantity2 = 1;
var defaultRatio2 = 1;
var defaultReduceFactor2 = 1;
var subdivideCount2 = 4;
var inverseFactorNumerator2 = 1;
var rgbMax2 = 255;
var hMax2 = 360;
var sMax2 = 100;
var lMax2 = 100;
...
var empty2 = 0;
var quarter3 = 0.25;
var threeQuarter2 = half4 + quarter3;
var defaultTransformValue2 = 1;
var minimumSize2 = 0;
var minimumLength2 = 0;
var zIndexFactorOffset2 = 1;
var defaultOpacity2 = 1;
var clickRadius2 = 1;
var touchEndLengthOffset2 = 1;
var minCoordinate2 = 0;
var removeDeleteCount2 = 1;
var removeMinIndex2 = 0;
var defaultFpsLimit2 = 120;
var minFpsLimit2 = 0;
var canvasFirstIndex2 = 0;
var loadRandomFactor2 = 1e4;
var loadMinIndex2 = 0;
var one2 = 1;
var none2 = 0;
var decayOffset2 = 1;
var tryCountIncrement2 = 1;
var minRetries2 = 0;
var rollFactor2 = 1;
var minZ2 = 0;
var defaultRadius2 = 0;
var posOffset2 = -quarter3;
var sizeFactor2 = 1.5;
var minLimit2 = 0;
var countOffset2 = 1;
var minCount2 = 0;
...
var manualCount = 0;
var lengthOffset2 = 1;
var defaultDensityFactor2 = 1;
var deleteCount2 = 1;
var touchDelay2 = 500;
var manualDefaultPosition2 = 50;
var defaultAngle2 = 0;
var identity2 = 1;
var minStrokeWidth2 = 0;
var lFactor2 = 1;
var defaultRgbMin2 = 0;

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Directions/MoveDirection.js
var MoveDirection2;
(function(MoveDirection3) {
  MoveDirection3["bottom"] = "bottom";
  MoveDirection3["bottomLeft"] = "bottom-left";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/TypeUtils.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/Vectors.js
var Vector3d2 = class _Vector3d {
  constructor(xOrCoords, y, z) {
    ...
    if (!isNumber2(xOrCoords) && xOrCoords) {
      this.x = xOrCoords.x;
      this.y = xOrCoords.y;
      const coords3d = xOrCoords;
      this.z = coords3d.z ? coords3d.z : originPoint2.z;
    } else if (xOrCoords !== void 0 && y !== void 0) {
      this.x = xOrCoords;
      this.y = y;
      this.z = z ?? originPoint2.z;
    } else {
      throw new Error(`${errorPrefix2} Vector3d not initialized correctly`);
    }
  }
  static get origin() {
    return _Vector3d.create(originPoint2.x, originPoint2.y, originPoint2.z);
  }
  get angle() {
    return Math.atan2(this.y, this.x);
  }
  ...
  getLengthSq() {
    return this.x ** squareExp4 + this.y ** squareExp4;
  }
  mult(n) {
    return _Vector3d.create(this.x * n, this.y * n, this.z * n);
  }
  ...
  normalize() {
    const length = this.length;
    if (length != none2) {
      this.multTo(inverseFactorNumerator2 / length);
    }
  }
  rotate(angle) {
    return _Vector3d.create(this.x * Math.cos(angle) - this.y * Math.sin(angle), this.x * Math.sin(angle) + this.y * Math.cos(angle), originPoint2.z);
  }
  setTo(c) {
    this.x = c.x;
    this.y = c.y;
    const v3d = c;
    this.z = v3d.z ? v3d.z : originPoint2.z;
  }
  sub(v) {
    return _Vector3d.create(this.x - v.x, this.y - v.y, this.z - v.z);
  }
...
var Vector2 = class _Vector extends Vector3d2 {
  constructor(xOrCoords, y) {
    super(xOrCoords, y, originPoint2.z);
  }
  static get origin() {
    return _Vector.create(originPoint2.x, originPoint2.y);
  }
  static clone(source) {
    return _Vector.create(source.x, source.y);
  }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/NumberUtils.js
...
function getRandom2() {
  const min = 0, max = 1;
  return clamp2(_random2(), min, max - Number.EPSILON);
}
function animate2(fn) {
  return _animationLoop2.nextFrame(fn);
}
function cancelAnimation2(handle) {
  _animationLoop2.cancel(handle);
}
function clamp2(num, min, max) {
  return Math.min(Math.max(num, min), max);
}
function randomInRange2(r) {
  const max = getRangeMax2(r), minOffset = 0;
...
function getRangeValue2(value) {
  return isNumber2(value) ? value : randomInRange2(value);
}
function getRangeMin2(value) {
  return isNumber2(value) ? value : value.min;
}
function getRangeMax2(value) {
  return isNumber2(value) ? value : value.max;
}
function setRangeValue2(source, value) {
  if (source === value || value === void 0 && isNumber2(source)) {
    return source;
  }
...
function getParticleDirectionAngle2(direction, position, center) {
  if (isNumber2(direction)) {
    return degToRad2(direction);
  }
  switch (direction) {
    case MoveDirection2.top:
      return -Math.PI * half4;
    case MoveDirection2.topRight:
      return -Math.PI * quarter3;
    case MoveDirection2.right:
      return empty2;
    case MoveDirection2.bottomRight:
      return Math.PI * quarter3;
    case MoveDirection2.bottom:
      return Math.PI * half4;
    case MoveDirection2.bottomLeft:
      return Math.PI * threeQuarter2;
    case MoveDirection2.left:
      return Math.PI;
    case MoveDirection2.topLeft:
      return -Math.PI * threeQuarter2;
    case MoveDirection2.inside:
      return Math.atan2(center.y - position.y, center.x - position.x);
    case MoveDirection2.outside:
      return Math.atan2(position.y - center.y, position.x - center.x);
    default:
      return getRandom2() * doublePI3;
  }
}
function getParticleBaseVelocity2(direction) {
  const baseVelocity = Vector2.origin;
  baseVelocity.length = 1;
  baseVelocity.angle = direction;
  return baseVelocity;
}
function calcExactPositionOrRandomFromSize2(data) {
  var _a, _b;
  return {
    x: ((_a = data.position) == null ? void 0 : _a.x) ?? getRandom2() * data.size.width,
    y: ((_b = data.position) == null ? void 0 : _b.y) ?? getRandom2() * data.size.height
  };
}

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/AnimationMode.js
var AnimationMode2;
(function(AnimationMode3) {
  AnimationMode3["auto"] = "auto";
  AnimationMode3["increase"] = "increase";
  AnimationMode3["decrease"] = "decrease";
  AnimationMode3["random"] = "random";
})(AnimationMode2 || (AnimationMode2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/AnimationStatus.js
var AnimationStatus2;
(function(AnimationStatus3) {
  AnimationStatus3["increasing"] = "increasing";
  AnimationStatus3["decreasing"] = "decreasing";
})(AnimationStatus2 || (AnimationStatus2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/DestroyType.js
var DestroyType2;
(function(DestroyType3) {
  DestroyType3["none"] = "none";
  DestroyType3["max"] = "max";
  DestroyType3["min"] = "min";
})(DestroyType2 || (DestroyType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Directions/OutModeDirection.js
var OutModeDirection2;
(function(OutModeDirection3) {
  OutModeDirection3["bottom"] = "bottom";
  OutModeDirection3["left"] = "left";
  OutModeDirection3["right"] = "right";
  OutModeDirection3["top"] = "top";
})(OutModeDirection2 || (OutModeDirection2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/PixelMode.js
var PixelMode2;
(function(PixelMode3) {
  PixelMode3["precise"] = "precise";
  PixelMode3["percent"] = "percent";
})(PixelMode2 || (PixelMode2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/StartValueType.js
var StartValueType2;
(function(StartValueType3) {
  StartValueType3["max"] = "max";
  StartValueType3["min"] = "min";
  StartValueType3["random"] = "random";
})(StartValueType2 || (StartValueType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/Utils.js
var _logger2 = {
  debug: console.debug,
  error: console.error,
  info: console.info,
...
function safeIntersectionObserver2(callback) {
  if (isSsr2() || typeof IntersectionObserver === "undefined") {
    return;
  }
  return new IntersectionObserver(callback);
}
...
function isInArray2(value, array) {
  const invalidIndex = -1;
  return value === array || isArray2(array) && array.indexOf(value) > invalidIndex;
}
function arrayRandomIndex2(array) {
  return Math.floor(getRandom2() * array.length);
}
...
function executeOnSingleOrMultiple2(obj, callback) {
  const defaultIndex2 = 0;
  return isArray2(obj) ? obj.map((item, index) => callback(item, index)) : callback(obj, defaultIndex2);
}
...
function initParticleNumericAnimationValue2(options, pxRatio) {
  const valueRange = options.value, animationOptions = options.animation, res = {
    delayTime: getRangeValue2(animationOptions.delay) * millisecondsToSeconds2,
    enable: animationOptions.enable,
    value: getRangeValue2(options.value) * pxRatio,
    max: getRangeMax2(valueRange) * pxRatio,
    min: getRangeMin2(valueRange) * pxRatio,
    loops: 0,
    maxLoops: getRangeValue2(animationOptions.count),
    time: 0
  }, decayOffset3 = 1;
  if (animationOptions.enable) {
    res.decay = decayOffset3 - getRangeValue2(animationOptions.decay);
    switch (animationOptions.mode) {
      case AnimationMode2.increase:
        res.status = AnimationStatus2.increasing;
        break;
      case AnimationMode2.decrease:
        res.status = AnimationStatus2.decreasing;
        break;
      case AnimationMode2.random:
        res.status = getRandom2() >= half4 ? AnimationStatus2.increasing : AnimationStatus2.decreasing;
        break;
    }
    const autoStatus = animationOptions.mode === AnimationMode2.auto;
    switch (animationOptions.startValue) {
      case StartValueType2.min:
        res.value = res.min;
        if (autoStatus) {
          res.status = AnimationStatus2.increasing;
        }
        break;
      case StartValueType2.max:
        res.value = res.max;
        if (autoStatus) {
          res.status = AnimationStatus2.decreasing;
        }
        break;
      case StartValueType2.random:
      default:
        res.value = randomInRange2(res);
        if (autoStatus) {
          res.status = getRandom2() >= half4 ? AnimationStatus2.increasing : AnimationStatus2.decreasing;
        }
        break;
...
function getPositionOrSize2(positionOrSize, canvasSize) {
  const isPercent = positionOrSize.mode === PixelMode2.percent;
  if (!isPercent) {
    const { mode: _, ...rest } = positionOrSize;
    return rest;
  }
  ...
  if (isPosition) {
    return {
      x: positionOrSize.x / percentDenominator2 * canvasSize.width,
      y: positionOrSize.y / percentDenominator2 * canvasSize.height
    };
  } else {
    return {
      width: positionOrSize.width / percentDenominator2 * canvasSize.width,
      height: positionOrSize.height / percentDenominator2 * canvasSize.height
    };
  }
}
...
function cloneStyle2(style) {
  ...
  for (const key in style) {
    const styleKey = style[key];
    if (!Object.prototype.hasOwnProperty.call(style, key) || isNull2(styleKey)) {
      continue;
    }
    const styleValue = (_a = style.getPropertyValue) == null ? void 0 : _a.call(style, styleKey);
    if (!styleValue) {
...
function computeFullScreenStyle2(zIndex) {
  const fullScreenStyle = document.createElement("div").style, radix = 10, style = {
    width: "100%",
    height: "100%",
    margin: "0",
...
var getFullScreenStyle2 = memoize2(computeFullScreenStyle2);

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/AlterType.js
var AlterType2;
(function(AlterType3) {
  AlterType3["darken"] = "darken";
  AlterType3["enlighten"] = "enlighten";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/ColorUtils.js
function stringToRgba2(engine, input) {
  if (!input) {
    return;
  }
  for (const manager of engine.colorManagers.values()) {
...
function rangeColorToRgb2(engine, input, index, useIndex = true) {
  if (!input) {
    return;
  }
  const color = isString2(input) ? { value: input } : input;
  if (isString2(color.value)) {
    return colorToRgb2(engine, color.value, index, useIndex);
  }
  if (isArray2(color.value)) {
    return rangeColorToRgb2(engine, {
      value: itemFromArray2(color.value, index, useIndex)
    });
  }
  for (const manager of engine.colorManagers.values()) {
    const res = manager.handleRangeColor(color);
...
function colorToRgb2(engine, input, index, useIndex = true) {
  if (!input) {
    return;
  }
  const color = isString2(input) ? { value: input } : input;
  if (isString2(color.value)) {
    return color.value === randomColorValue2 ? getRandomRgbColor2() : stringToRgb2(engine, color.value);
  }
  if (isArray2(color.value)) {
    return colorToRgb2(engine, {
      value: itemFromArray2(color.value, index, useIndex)
    });
  }
  for (const manager of engine.colorManagers.values()) {
...
function rangeColorToHsl2(engine, color, index, useIndex = true) {
  const rgb = rangeColorToRgb2(engine, color, index, useIndex);
  return rgb ? rgbToHsl2(rgb) : void 0;
}
function rgbToHsl2(color) {
  const r1 = color.r / rgbMax2, g1 = color.g / rgbMax2, b1 = color.b / rgbMax2, max = Math.max(r1, g1, b1), min = Math.min(r1, g1, b1), res = {
    h: hMin2,
    l: (max + min) * half4,
    s: sMin2
  };
  if (max !== min) {
    res.s = res.l < half4 ? (max - min) / (max + min) : (max - min) / (double4 - max - min);
    res.h = r1 === max ? (g1 - b1) / (max - min) : res.h = g1 === max ? double4 + (b1 - r1) / (max - min) : double4 * double4 + (r1 - g1) / (max - min);
  }
  res.l *= lMax2;
  res.s *= sMax2;
  res.h *= hPhase2;
...
function stringToRgb2(engine, input) {
  return stringToRgba2(engine, input);
}
function getRandomRgbColor2(min) {
  const fixedMin = min ?? defaultRgbMin2, fixedMax = rgbMax2 + identity2;
  return {
    b: Math.floor(randomInRange2(setRangeValue2(fixedMin, fixedMax))),
    g: Math.floor(randomInRange2(setRangeValue2(fixedMin, fixedMax))),
    r: Math.floor(randomInRange2(setRangeValue2(fixedMin, fixedMax)))
  };
}
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/CanvasUtils.js
function paintBase2(context, dimension, baseColor) {
  context.fillStyle = baseColor ?? "rgba(0,0,0,0)";
  context.fillRect(originPoint2.x, originPoint2.y, dimension.width, dimension.height);
}
function paintImage2(context, dimension, image, opacity) {
  ...
  context.globalAlpha = opacity;
  context.drawImage(image, originPoint2.x, originPoint2.y, dimension.width, dimension.height);
  context.globalAlpha = 1;
}
function clear2(context, dimension) {
  context.clearRect(originPoint2.x, originPoint2.y, dimension.width, dimension.height);
}
function drawParticle2(data) {
  const { container, context, particle, delta, colorStyles, backgroundMask, composite, radius, opacity, shadow, transform } = data, pos = particle.getPosition(), angle = particle.rotation + (particle.pathRotation ? particle.velocity.angle : defaultAngle2), rotateData = {
    sin: Math.sin(angle),
    cos: Math.cos(angle)
  }, rotating = !!angle, transformData = {
    a: rotateData.cos * (transform.a ?? defaultTransform2.a),
    b: rotating ? rotateData.sin * (transform.b ?? identity2) : transform.b ?? defaultTransform2.b,
    c: rotating ? -rotateData.sin * (transform.c ?? identity2) : transform.c ?? defaultTransform2.c,
    d: rotateData.cos * (transform.d ?? defaultTransform2.d)
  };
  context.setTransform(transformData.a, transformData.b, transformData.c, transformData.d, pos.x, pos.y);
  if (backgroundMask) {
    context.globalCompositeOperation = composite;
  ...
  if (shadow.enable && shadowColor) {
    context.shadowBlur = shadow.blur;
    context.shadowColor = getStyleFromRgb2(shadowColor);
    context.shadowOffsetX = shadow.offset.x;
    context.shadowOffsetY = shadow.offset.y;
  }
  if (colorStyles.fill) {
  ...
  const strokeWidth = particle.strokeWidth ?? minStrokeWidth2;
  context.lineWidth = strokeWidth;
  if (colorStyles.stroke) {
    context.strokeStyle = colorStyles.stroke;
  }
  ...
  drawShape2(drawData);
  drawShapeAfterDraw2(drawData);
  drawEffect2(drawData);
  context.globalCompositeOperation = "source-over";
  context.resetTransform();
}
function drawEffect2(data) {
  const { container, context, particle, radius, opacity, delta, transformData } = data;
  if (!particle.effect) {
    return;
  }
...
function drawShape2(data) {
  ...
  if (strokeWidth > minStrokeWidth2) {
    context.stroke();
  }
  if (particle.shapeFill) {
    context.fill();
...
function drawShapeAfterDraw2(data) {
  const { container, context, particle, radius, opacity, delta, transformData } = data;
  if (!particle.shape) {
    return;
  }
...
function alterHsl2(color, type, value) {
  return {
    h: color.h,
    s: color.s,
    l: color.l + (type === AlterType2.darken ? -lFactor2 : lFactor2) * value
  };
}

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Canvas.js
function setTransformValue2(factor, newFactor, key) {
  const newValue = newFactor[key];
  if (newValue !== void 0) {
    factor[key] = (factor[key] ?? defaultTransformValue2) * newValue;
  }
}
function setStyle2(canvas, style, important = false) {
  if (!style) {
    return;
  }
  const element = canvas;
...
var Canvas2 = class {
  constructor(container, engine) {
    ...
    this._getPluginParticleColors = (particle) => {
      ...
      for (const plugin of this._colorPlugins) {
        if (!fColor && plugin.particleFillColor) {
          fColor = rangeColorToHsl2(this._engine, plugin.particleFillColor(particle));
        }
        if (!sColor && plugin.particleStrokeColor) {
          sColor = rangeColorToHsl2(this._engine, plugin.particleStrokeColor(particle));
        }
        if (fColor && sColor) {
          break;
        }
    ...
    this._initCover = async () => {
      const options = this.container.actualOptions, cover = options.backgroundMask.cover, color = cover.color;
      if (color) {
        const coverRgb = rangeColorToRgb2(this._engine, color);
        if (coverRgb) {
          const coverColor = {
            ...coverRgb,
            a: cover.opacity
          };
          this._coverColorStyle = getStyleFromRgb2(coverColor, coverColor.a);
        }
      } else {
        await new Promise((resolve, reject) => {
          if (!cover.image) {
    ...
    this._initTrail = async () => {
      ...
      const opacity = inverseFactorNumerator2 / trail.length;
      if (trailFill.color) {
        const fillColor = rangeColorToRgb2(this._engine, trailFill.color);
        if (!fillColor) {
          return;
        }
        this._trailFill = {
    ...
    this._paintBase = (baseColor) => {
      this.draw((ctx) => paintBase2(ctx, this.size, baseColor));
    };
    this._paintImage = (image, opacity) => {
      this.draw((ctx) => paintImage2(ctx, this.size, image, opacity));
    };
    this._repairStyle = () => {
      const element = this.element;
      if (!element) {
    ...
    this._resetOriginalStyle = () => {
      ...
      setStyle2(element, originalStyle, true);
    };
    this._safeMutationObserver = (callback) => {
      if (!this._mutationObserver) {
        return;
    ...
    this._setFullScreenStyle = () => {
      ...
      setStyle2(element, getFullScreenStyle2(this.container.actualOptions.fullScreen.zIndex), true);
    };
    this._engine = engine;
    this._standardSize = {
      height: 0,
  ...
  clear() {
    ...
    if (options.backgroundMask.enable) {
      this.paint();
    } else if (trail.enable && trail.length > minimumLength2 && trailFill) {
      if (trailFill.color) {
        this._paintBase(getStyleFromRgb2(trailFill.color, trailFill.opacity));
      } else if (trailFill.image) {
        this._paintImage(trailFill.image, trailFill.opacity);
      }
    } else if (options.clear) {
      this.draw((ctx) => {
        clear2(ctx, this.size);
      });
    }
  }
  destroy() {
  ...
  drawParticle(particle, delta) {
    ...
    this.draw((ctx) => {
      var _a;
      const container = this.container, options = container.actualOptions, zIndexOptions = particle.options.zIndex, zIndexFactor = zIndexFactorOffset2 - particle.zIndexFactor, zOpacityFactor = zIndexFactor ** zIndexOptions.opacityRate, opacity = particle.bubble.opacity ?? ((_a = particle.opacity) == null ? void 0 : _a.value) ?? defaultOpacity2, strokeOpacity = particle.strokeOpacity ?? opacity, zOpacity = opacity * zOpacityFactor, zStrokeOpacity = strokeOpacity * zOpacityFactor, transform = {}, colorStyles = {
        fill: fColor ? getStyleFromHsl2(fColor, zOpacity) : void 0
      };
      colorStyles.stroke = sColor ? getStyleFromHsl2(sColor, zStrokeOpacity) : colorStyles.fill;
      this._applyPreDrawUpdaters(ctx, particle, radius, zOpacity, colorStyles, transform);
      drawParticle2({
        container,
        context: ctx,
  ...
  drawParticlePlugin(plugin, particle, delta) {
    this.draw((ctx) => drawParticlePlugin2(ctx, plugin, particle, delta));
  }
  drawPlugin(plugin, delta) {
    this.draw((ctx) => drawPlugin2(ctx, plugin, delta));
  }
  async init() {
    this._safeMutationObserver((obs) => obs.disconnect());
    this._mutationObserver = safeMutationObserver2((records) => {
      for (const record of records) {
        if (record.type === "attributes" && record.attributeName === "style") {
          this._repairStyle();
        }
  ...
  initBackground() {
    ...
    if (background.color) {
      const color = rangeColorToRgb2(this._engine, background.color);
      elementStyle.backgroundColor = color ? getStyleFromRgb2(color, background.opacity) : "";
    } else {
      elementStyle.backgroundColor = "";
    }
    elementStyle.backgroundImage = background.image || "";
  ...
  loadCanvas(canvas) {
    ...
    this._generated = canvas.dataset && generatedAttribute2 in canvas.dataset ? canvas.dataset[generatedAttribute2] === "true" : this._generated;
    this.element = canvas;
    this.element.ariaHidden = "true";
    this._originalStyle = cloneStyle2(this.element.style);
    const standardSize = this._standardSize;
    standardSize.height = canvas.offsetHeight;
    standardSize.width = canvas.offsetWidth;
    const pxRatio = this.container.retina.pixelRatio, retinaSize = this.size;
  ...
  stop() {
    this._safeMutationObserver((obs) => obs.disconnect());
    this._mutationObserver = void 0;
    this.draw((ctx) => clear2(ctx, this.size));
  }
  async windowResize() {
    if (!this.element || !this.resize()) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/InteractivityDetect.js
var InteractivityDetect2;
(function(InteractivityDetect3) {
  InteractivityDetect3["canvas"] = "canvas";
  InteractivityDetect3["parent"] = "parent";
  InteractivityDetect3["window"] = "window";
})(InteractivityDetect2 || (InteractivityDetect2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/EventListeners.js
function manageListener2(element, event, handler, add, options) {
  if (add) {
    let addOptions = { passive: true };
    if (isBoolean2(options)) {
      addOptions.capture = options;
    } else if (options !== void 0) {
      addOptions = options;
    }
  ...
  constructor(container) {
    ...
    this._doMouseTouchClick = (e) => {
      ...
      if (this._canPush) {
        ...
        mouseInteractivity.clickTime = (/* @__PURE__ */ new Date()).getTime();
        const onClick = options.interactivity.events.onClick;
        executeOnSingleOrMultiple2(onClick.mode, (mode) => this.container.handleClickMode(mode));
      }
      if (e.type === "touchend") {
        setTimeout(() => this._mouseTouchFinish(), touchDelay2);
      }
    };
    this._handleThemeChange = (e) => {
      const mediaEvent = e, container2 = this.container, options = container2.options, defaultThemes = options.defaultThemes, themeName = mediaEvent.matches ? defaultThemes.dark : defaultThemes.light, theme = options.themes.find((theme2) => theme2.name === themeName);
    ...
    this._handleWindowResize = () => {
      ...
      this._resizeTimeout = setTimeout(() => void handleResize(), this.container.actualOptions.interactivity.events.resize.delay * millisecondsToSeconds2);
    };
    this._manageInteractivityListeners = (mouseLeaveTmpEvent, add) => {
      const handlers = this._handlers, container2 = this.container, options = container2.actualOptions, interactivityEl = container2.interactivity.element;
      if (!interactivityEl) {
      ...
      manageListener2(interactivityEl, mouseMoveEvent2, handlers.mouseMove, add);
      manageListener2(interactivityEl, touchStartEvent2, handlers.touchStart, add);
      manageListener2(interactivityEl, touchMoveEvent2, handlers.touchMove, add);
      if (!options.interactivity.events.onClick.enable) {
        manageListener2(interactivityEl, touchEndEvent2, handlers.touchEnd, add);
      } else {
        manageListener2(interactivityEl, touchEndEvent2, handlers.touchEndClick, add);
        manageListener2(interactivityEl, mouseUpEvent2, handlers.mouseUp, add);
        manageListener2(interactivityEl, mouseDownEvent2, handlers.mouseDown, add);
      }
      manageListener2(interactivityEl, mouseLeaveTmpEvent, handlers.mouseLeave, add);
      manageListener2(interactivityEl, touchCancelEvent2, handlers.touchCancel, add);
    };
    this._manageListeners = (add) => {
      const handlers = this._handlers, container2 = this.container, options = container2.actualOptions, detectType = options.interactivity.detectsOn, canvasEl = container2.canvas.element;
      let mouseLeaveTmpEvent = mouseLeaveEvent2;
      if (detectType === InteractivityDetect2.window) {
        container2.interactivity.element = window;
        mouseLeaveTmpEvent = mouseOutEvent2;
      } else if (detectType === InteractivityDetect2.parent && canvasEl) {
        container2.interactivity.element = canvasEl.parentElement ?? canvasEl.parentNode;
      } else {
        container2.interactivity.element = canvasEl;
      }
      ...
      this._manageInteractivityListeners(mouseLeaveTmpEvent, add);
      if (document) {
        manageListener2(document, visibilityChangeEvent2, handlers.visibilityChange, add, false);
      }
    };
    this._manageMediaMatch = (add) => {
      const handlers = this._handlers, mediaMatch = safeMatchMedia2("(prefers-color-scheme: dark)");
      if (!mediaMatch) {
        return;
      }
      if (mediaMatch.addEventListener !== void 0) {
    ...
    this._manageResize = (add) => {
      ...
      if (typeof ResizeObserver === "undefined") {
        manageListener2(window, resizeEvent2, handlers.resize, add);
        return;
      }
      const canvasEl = container2.canvas.element;
      if (this._resizeObserver && !add) {
    ...
    this._mouseTouchFinish = () => {
      ...
      delete mouse.clickPosition;
      delete mouse.downPosition;
      interactivity.status = mouseLeaveEvent2;
      mouse.inside = false;
      mouse.clicking = false;
    };
    this._mouseTouchMove = (e) => {
      ...
      if (e.type.startsWith("pointer")) {
        ...
        } else if (options.interactivity.detectsOn === InteractivityDetect2.parent) {
          const source = mouseEvent.target, target = mouseEvent.currentTarget;
          if (source && target && canvasEl) {
            const sourceRect = source.getBoundingClientRect(), targetRect = target.getBoundingClientRect(), canvasRect = canvasEl.getBoundingClientRect();
            pos = {
              x: mouseEvent.offsetX + double4 * sourceRect.left - (targetRect.left + canvasRect.left),
              y: mouseEvent.offsetY + double4 * sourceRect.top - (targetRect.top + canvasRect.top)
            };
          } else {
            pos = {
              x: mouseEvent.offsetX ?? mouseEvent.clientX,
        ...
        this._canPush = e.type !== "touchmove";
        if (canvasEl) {
          const touchEvent = e, lastTouch = touchEvent.touches[touchEvent.touches.length - lengthOffset2], canvasRect = canvasEl.getBoundingClientRect();
          pos = {
            x: lastTouch.clientX - (canvasRect.left ?? minCoordinate2),
            y: lastTouch.clientY - (canvasRect.top ?? minCoordinate2)
          };
        }
      }
      const pxRatio = container2.retina.pixelRatio;
      ...
      interactivity.mouse.position = pos;
      interactivity.status = mouseMoveEvent2;
    };
    this._touchEnd = (e) => {
      const evt = e, touches = Array.from(evt.changedTouches);
      for (const touch of touches) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/EventType.js
var EventType2;
(function(EventType3) {
  EventType3["configAdded"] = "configAdded";
  EventType3["containerInit"] = "containerInit";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/OptionsColor.js
var OptionsColor2 = class _OptionsColor {
  ...
  static create(source, data) {
    ...
    color.load(source);
    if (data !== void 0) {
      if (isString2(data) || isArray2(data)) {
        color.load({ value: data });
      } else {
        color.load(data);
      }
  ...
  load(data) {
    ...
    if (!isNull2(data.value)) {
      this.value = data.value;
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Background/Background.js
var Background2 = class {
  constructor() {
    this.color = new OptionsColor2();
    this.color.value = "";
    this.image = "";
    this.position = "";
    this.repeat = "";
  ...
  load(data) {
    ...
    if (data.color !== void 0) {
      this.color = OptionsColor2.create(this.color, data.color);
    }
    if (data.image !== void 0) {
      this.image = data.image;
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/BackgroundMask/BackgroundMaskCover.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/BackgroundMask/BackgroundMask.js
var BackgroundMask2 = class {
  constructor() {
    this.composite = "destination-out";
    this.cover = new BackgroundMaskCover2();
    this.enable = false;
  }
  load(data) {
    if (isNull2(data)) {
    ...
    if (data.cover !== void 0) {
      const cover = data.cover, color = isString2(data.cover) ? { color: data.cover } : data.cover;
      this.cover.load(cover.color !== void 0 || cover.image !== void 0 ? cover : { color });
    }
    if (data.enable !== void 0) {
      this.enable = data.enable;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/FullScreen/FullScreen.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/ClickEvent.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/DivType.js
var DivType2;
(function(DivType3) {
  DivType3["circle"] = "circle";
  DivType3["rectangle"] = "rectangle";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/DivEvent.js
var DivEvent2 = class {
  constructor() {
    this.selectors = [];
    this.enable = false;
    this.mode = [];
    this.type = DivType2.circle;
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/Parallax.js
var Parallax2 = class {
  constructor() {
    this.enable = false;
    this.force = 2;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/HoverEvent.js
var HoverEvent2 = class {
  constructor() {
    this.enable = false;
    this.mode = [];
    this.parallax = new Parallax2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/ResizeEvent.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Events/Events.js
var Events2 = class {
  constructor() {
    this.onClick = new ClickEvent2();
    this.onDiv = new DivEvent2();
    this.onHover = new HoverEvent2();
    this.resize = new ResizeEvent2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
    ...
    const onDiv = data.onDiv;
    if (onDiv !== void 0) {
      this.onDiv = executeOnSingleOrMultiple2(onDiv, (t) => {
        const tmp = new DivEvent2();
        tmp.load(t);
        return tmp;
      });
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Modes/Modes.js
var Modes2 = class {
  constructor(engine, container) {
    this._engine = engine;
    this._container = container;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Interactivity/Interactivity.js
var Interactivity2 = class {
  constructor(engine, container) {
    this.detectsOn = InteractivityDetect2.window;
    this.events = new Events2();
    this.modes = new Modes2(engine, container);
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/ManualParticle.js
var ManualParticle2 = class {
  load(data) {
    ...
    if (data.position) {
      this.position = {
        x: data.position.x ?? manualDefaultPosition2,
        y: data.position.y ?? manualDefaultPosition2,
        mode: data.position.mode ?? PixelMode2.percent
      };
    }
    if (data.options) {
      this.options = deepExtend2({}, data.options);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/ResponsiveMode.js
var ResponsiveMode2;
(function(ResponsiveMode3) {
  ResponsiveMode3["screen"] = "screen";
  ResponsiveMode3["canvas"] = "canvas";
})(ResponsiveMode2 || (ResponsiveMode2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Responsive.js
var Responsive2 = class {
  constructor() {
    this.maxWidth = Infinity;
    this.options = {};
    this.mode = ResponsiveMode2.canvas;
  }
  load(data) {
    if (isNull2(data)) {
      return;
    }
    if (!isNull2(data.maxWidth)) {
      this.maxWidth = data.maxWidth;
    }
    if (!isNull2(data.mode)) {
      if (data.mode === ResponsiveMode2.screen) {
        this.mode = ResponsiveMode2.screen;
      } else {
        this.mode = ResponsiveMode2.canvas;
      }
    }
    if (!isNull2(data.options)) {
      this.options = deepExtend2({}, data.options);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/ThemeMode.js
var ThemeMode2;
(function(ThemeMode3) {
  ThemeMode3["any"] = "any";
  ThemeMode3["dark"] = "dark";
  ThemeMode3["light"] = "light";
})(ThemeMode2 || (ThemeMode2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Theme/ThemeDefault.js
var ThemeDefault2 = class {
  constructor() {
    this.auto = false;
    this.mode = ThemeMode2.any;
    this.value = false;
  }
  load(data) {
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Theme/Theme.js
var Theme2 = class {
  constructor() {
    this.name = "";
    this.default = new ThemeDefault2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/AnimationOptions.js
var AnimationOptions2 = class {
  ...
  load(data) {
    ...
    if (data.count !== void 0) {
      this.count = setRangeValue2(data.count);
    }
    if (data.enable !== void 0) {
      this.enable = data.enable;
    }
    if (data.speed !== void 0) {
      this.speed = setRangeValue2(data.speed);
    }
    if (data.decay !== void 0) {
      this.decay = setRangeValue2(data.decay);
    }
    if (data.delay !== void 0) {
      this.delay = setRangeValue2(data.delay);
    }
    if (data.sync !== void 0) {
      this.sync = data.sync;
    }
...
var RangedAnimationOptions2 = class extends AnimationOptions2 {
  constructor() {
    super();
    this.mode = AnimationMode2.auto;
    this.startValue = StartValueType2.random;
  }
  load(data) {
    super.load(data);
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/ColorAnimation.js
var ColorAnimation2 = class extends AnimationOptions2 {
  constructor() {
    super();
    this.offset = 0;
    this.sync = true;
  ...
  load(data) {
    ...
    if (data.offset !== void 0) {
      this.offset = setRangeValue2(data.offset);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/HslAnimation.js
var HslAnimation2 = class {
  constructor() {
    this.h = new ColorAnimation2();
    this.s = new ColorAnimation2();
    this.l = new ColorAnimation2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/AnimatableColor.js
var AnimatableColor2 = class _AnimatableColor extends OptionsColor2 {
  constructor() {
    super();
    this.animation = new HslAnimation2();
  }
  static create(source, data) {
    const color = new _AnimatableColor();
    color.load(source);
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/CollisionMode.js
var CollisionMode2;
(function(CollisionMode3) {
  CollisionMode3["absorb"] = "absorb";
  CollisionMode3["bounce"] = "bounce";
  CollisionMode3["destroy"] = "destroy";
})(CollisionMode2 || (CollisionMode2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Collisions/CollisionsAbsorb.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Collisions/CollisionsOverlap.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/ValueWithRandom.js
var ValueWithRandom2 = class {
  ...
  load(data) {
    ...
    if (!isNull2(data.value)) {
      this.value = setRangeValue2(data.value);
    }
  }
};
var AnimationValueWithRandom2 = class extends ValueWithRandom2 {
  constructor() {
    super();
    this.animation = new AnimationOptions2();
  }
  load(data) {
    super.load(data);
    if (isNull2(data)) {
...
var RangedAnimationValueWithRandom2 = class extends AnimationValueWithRandom2 {
  constructor() {
    super();
    this.animation = new RangedAnimationOptions2();
  }
  load(data) {
    super.load(data);
  }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Bounce/ParticlesBounceFactor.js
var ParticlesBounceFactor2 = class extends ValueWithRandom2 {
  constructor() {
    super();
    this.value = 1;
  }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Bounce/ParticlesBounce.js
var ParticlesBounce2 = class {
  constructor() {
    this.horizontal = new ParticlesBounceFactor2();
    this.vertical = new ParticlesBounceFactor2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Collisions/Collisions.js
var Collisions2 = class {
  constructor() {
    this.absorb = new CollisionsAbsorb2();
    this.bounce = new ParticlesBounce2();
    this.enable = false;
    this.maxSpeed = 50;
    this.mode = CollisionMode2.bounce;
    this.overlap = new CollisionsOverlap2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
    ...
    if (data.maxSpeed !== void 0) {
      this.maxSpeed = setRangeValue2(data.maxSpeed);
    }
    if (data.mode !== void 0) {
      this.mode = data.mode;
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Effect/Effect.js
var Effect2 = class {
  constructor() {
    this.close = true;
    this.fill = true;
  ...
  load(data) {
    ...
    if (options !== void 0) {
      for (const effect in options) {
        const item = options[effect];
        if (item) {
          this.options[effect] = deepExtend2(this.options[effect] ?? {}, item);
        }
      }
    }
    if (data.close !== void 0) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveAngle.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveAttract.js
var MoveAttract2 = class {
  ...
  load(data) {
    ...
    if (data.distance !== void 0) {
      this.distance = setRangeValue2(data.distance);
    }
    if (data.enable !== void 0) {
      this.enable = data.enable;
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveCenter.js
var MoveCenter2 = class {
  constructor() {
    this.x = 50;
    this.y = 50;
    this.mode = PixelMode2.percent;
    this.radius = 0;
  }
  load(data) {
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveGravity.js
var MoveGravity2 = class {
  ...
  load(data) {
    ...
    if (data.acceleration !== void 0) {
      this.acceleration = setRangeValue2(data.acceleration);
    }
    if (data.enable !== void 0) {
      this.enable = data.enable;
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/Path/MovePath.js
var MovePath2 = class {
  constructor() {
    this.clamp = true;
    this.delay = new ValueWithRandom2();
    this.enable = false;
    this.options = {};
  }
  load(data) {
    ...
    this.generator = data.generator;
    if (data.options) {
      this.options = deepExtend2(this.options, data.options);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveTrailFill.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveTrail.js
var MoveTrail2 = class {
  constructor() {
    this.enable = false;
    this.length = 10;
    this.fill = new MoveTrailFill2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/OutMode.js
var OutMode2;
(function(OutMode3) {
  OutMode3["bounce"] = "bounce";
  OutMode3["none"] = "none";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/OutModes.js
var OutModes2 = class {
  constructor() {
    this.default = OutMode2.out;
  }
  load(data) {
    if (isNull2(data)) {
      return;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/Spin.js
var Spin2 = class {
  constructor() {
    this.acceleration = 0;
    this.enable = false;
  ...
  load(data) {
    ...
    if (data.position) {
      this.position = deepExtend2({}, data.position);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/Move.js
var Move2 = class {
  constructor() {
    this.angle = new MoveAngle2();
    this.attract = new MoveAttract2();
    this.center = new MoveCenter2();
    this.decay = 0;
    this.distance = {};
    this.direction = MoveDirection2.none;
    this.drift = 0;
    this.enable = false;
    this.gravity = new MoveGravity2();
    this.path = new MovePath2();
    this.outModes = new OutModes2();
    this.random = false;
    this.size = false;
    this.speed = 2;
    this.spin = new Spin2();
    this.straight = false;
    this.trail = new MoveTrail2();
    this.vibrate = false;
    this.warp = false;
  }
  load(data) {
    ...
    this.angle.load(isNumber2(data.angle) ? { value: data.angle } : data.angle);
    this.attract.load(data.attract);
    this.center.load(data.center);
    if (data.decay !== void 0) {
      this.decay = setRangeValue2(data.decay);
    ...
    if (data.distance !== void 0) {
      this.distance = isNumber2(data.distance) ? {
        horizontal: data.distance,
        vertical: data.distance
      } : { ...data.distance };
    }
    if (data.drift !== void 0) {
      this.drift = setRangeValue2(data.drift);
    }
    if (data.enable !== void 0) {
      this.enable = data.enable;
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Opacity/OpacityAnimation.js
var OpacityAnimation2 = class extends RangedAnimationOptions2 {
  constructor() {
    super();
    this.destroy = DestroyType2.none;
    this.speed = 2;
  }
  load(data) {
    super.load(data);
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Opacity/Opacity.js
var Opacity2 = class extends RangedAnimationValueWithRandom2 {
  constructor() {
    super();
    this.animation = new OpacityAnimation2();
    this.value = 1;
  }
  load(data) {
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Number/ParticlesDensity.js
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Modes/LimitMode.js
var LimitMode2;
(function(LimitMode3) {
  LimitMode3["delete"] = "delete";
  LimitMode3["wait"] = "wait";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Number/ParticlesNumberLimit.js
var ParticlesNumberLimit2 = class {
  constructor() {
    this.mode = LimitMode2.delete;
    this.value = 0;
  }
  load(data) {
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Number/ParticlesNumber.js
var ParticlesNumber2 = class {
  constructor() {
    this.density = new ParticlesDensity2();
    this.limit = new ParticlesNumberLimit2();
    this.value = 0;
  }
  load(data) {
    if (isNull2(data)) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Shadow.js
var Shadow2 = class {
  constructor() {
    this.blur = 0;
    this.color = new OptionsColor2();
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Shape/Shape.js
var Shape2 = class {
  constructor() {
    this.close = true;
    this.fill = true;
  ...
  load(data) {
    ...
    if (options !== void 0) {
      for (const shape in options) {
        const item = options[shape];
        if (item) {
          this.options[shape] = deepExtend2(this.options[shape] ?? {}, item);
        }
      }
    }
    if (data.close !== void 0) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Size/SizeAnimation.js
var SizeAnimation2 = class extends RangedAnimationOptions2 {
  constructor() {
    super();
    this.destroy = DestroyType2.none;
    this.speed = 5;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Size/Size.js
var Size2 = class extends RangedAnimationValueWithRandom2 {
  constructor() {
    super();
    this.animation = new SizeAnimation2();
    this.value = 3;
  }
  load(data) {
    super.load(data);
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Stroke.js
var Stroke2 = class {
  constructor() {
    this.width = 0;
  }
  load(data) {
    ...
    if (data.color !== void 0) {
      this.color = AnimatableColor2.create(this.color, data.color);
    }
    if (data.width !== void 0) {
      this.width = setRangeValue2(data.width);
    }
    if (data.opacity !== void 0) {
      this.opacity = setRangeValue2(data.opacity);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/ZIndex/ZIndex.js
var ZIndex2 = class extends ValueWithRandom2 {
  constructor() {
    super();
    this.opacityRate = 1;
    this.sizeRate = 1;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Particles/ParticlesOptions.js
var ParticlesOptions2 = class {
  constructor(engine, container) {
    ...
    this.color = new AnimatableColor2();
    this.color.value = "#fff";
    this.effect = new Effect2();
    this.groups = {};
    this.move = new Move2();
    this.number = new ParticlesNumber2();
    this.opacity = new Opacity2();
    this.reduceDuplicates = false;
    this.shadow = new Shadow2();
    this.shape = new Shape2();
    this.size = new Size2();
    this.stroke = new Stroke2();
    this.zIndex = new ZIndex2();
  }
  load(data) {
    if (isNull2(data)) {
      return;
    ...
    if (data.groups !== void 0) {
      for (const group of Object.keys(data.groups)) {
        ...
        const item = data.groups[group];
        if (item !== void 0) {
          this.groups[group] = deepExtend2(this.groups[group] ?? {}, item);
        }
      }
    }
    if (data.reduceDuplicates !== void 0) {
    ...
    this.bounce.load(data.bounce);
    this.color.load(AnimatableColor2.create(this.color, data.color));
    this.effect.load(data.effect);
    this.move.load(data.move);
    this.number.load(data.number);
    this.opacity.load(data.opacity);
    ...
    this.collisions.load(data.collisions);
    if (data.interactivity !== void 0) {
      this.interactivity = deepExtend2({}, data.interactivity);
    }
    const strokeToLoad = data.stroke;
    if (strokeToLoad) {
      this.stroke = executeOnSingleOrMultiple2(strokeToLoad, (t) => {
        const tmp = new Stroke2();
        tmp.load(t);
        return tmp;
      });
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/OptionsUtils.js
...
function loadParticlesOptions2(engine, container, ...sourceOptionsArr) {
  const options = new ParticlesOptions2(engine, container);
  loadOptions2(options, ...sourceOptionsArr);
  return options;
}

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Options/Classes/Options.js
var Options2 = class {
  constructor(engine, container) {
    this._findDefaultTheme = (mode) => {
      return this.themes.find((theme) => theme.default.value && theme.default.mode === mode) ?? this.themes.find((theme) => theme.default.value && theme.default.mode === ThemeMode2.any);
    };
    this._importPreset = (preset) => {
      this.load(this._engine.getPreset(preset));
    };
    ...
    this.backgroundMask = new BackgroundMask2();
    this.clear = true;
    this.defaultThemes = {};
    this.delay = 0;
    this.fullScreen = new FullScreen2();
    this.detectRetina = true;
    this.duration = 0;
    this.fpsLimit = 120;
    this.interactivity = new Interactivity2(engine, container);
    this.manualParticles = [];
    this.particles = loadParticlesOptions2(this._engine, this._container);
    this.pauseOnBlur = true;
    this.pauseOnOutsideViewport = true;
    this.responsive = [];
    this.smooth = false;
  ...
  load(data) {
    ...
    if (data.preset !== void 0) {
      executeOnSingleOrMultiple2(data.preset, (preset) => this._importPreset(preset));
    }
    if (data.autoPlay !== void 0) {
      this.autoPlay = data.autoPlay;
    }
    ...
    if (data.duration !== void 0) {
      this.duration = setRangeValue2(data.duration);
    }
    const fpsLimit = data.fpsLimit;
    if (fpsLimit !== void 0) {
      this.fpsLimit = fpsLimit;
    ...
    if (data.manualParticles) {
      this.manualParticles = data.manualParticles.map((t) => {
        const tmp = new ManualParticle2();
        tmp.load(t);
        return tmp;
      });
    }
    this.particles.load(data.particles);
    this.style = deepExtend2(this.style, data.style);
    this._engine.loadOptions(this, data);
    if (data.smooth !== void 0) {
      this.smooth = data.smooth;
    }
    ...
    if (data.responsive !== void 0) {
      for (const responsive of data.responsive) {
        const optResponsive = new Responsive2();
        optResponsive.load(responsive);
        this.responsive.push(optResponsive);
      }
    }
    ...
    this.defaultThemes.dark = (_a = this._findDefaultTheme(ThemeMode2.dark)) == null ? void 0 : _a.name;
    this.defaultThemes.light = (_b = this._findDefaultTheme(ThemeMode2.light)) == null ? void 0 : _b.name;
  }
  setResponsive(width, pxRatio, defaultOptions) {
    this.load(defaultOptions);
    const responsiveOptions = this.responsive.find((t) => t.mode === ResponsiveMode2.screen && screen ? t.maxWidth > screen.availWidth : t.maxWidth * pxRatio > width);
    this.load(responsiveOptions == null ? void 0 : responsiveOptions.options);
    return responsiveOptions == null ? void 0 : responsiveOptions.maxWidth;
  }
  setTheme(name) {
    if (name) {
      ...
      const mediaMatch = safeMatchMedia2("(prefers-color-scheme: dark)"), clientDarkMode = mediaMatch == null ? void 0 : mediaMatch.matches, defaultTheme = this._findDefaultTheme(clientDarkMode ? ThemeMode2.dark : ThemeMode2.light);
      if (defaultTheme) {
        this.load(defaultTheme.options);
      }
    }
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/InteractorType.js
var InteractorType2;
(function(InteractorType3) {
  InteractorType3["external"] = "external";
  InteractorType3["particles"] = "particles";
})(InteractorType2 || (InteractorType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/InteractionManager.js
var InteractionManager2 = class {
  ...
  async init() {
    ...
    for (const interactor of this._interactors) {
      switch (interactor.type) {
        case InteractorType2.external:
          this._externalInteractors.push(interactor);
          break;
        case InteractorType2.particles:
          this._particleInteractors.push(interactor);
          break;
      }
      interactor.init();
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/ParticleOutType.js
var ParticleOutType2;
(function(ParticleOutType3) {
  ParticleOutType3["normal"] = "normal";
  ParticleOutType3["inside"] = "inside";
  ParticleOutType3["outside"] = "outside";
})(ParticleOutType2 || (ParticleOutType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Particle.js
function loadEffectData2(effect, effectOptions, id, reduceDuplicates) {
  const effectData = effectOptions.options[effect];
  if (!effectData) {
    return;
  }
  return deepExtend2({
    close: effectOptions.close,
    fill: effectOptions.fill
  }, itemFromSingleOrMultiple2(effectData, id, reduceDuplicates));
}
function loadShapeData2(shape, shapeOptions, id, reduceDuplicates) {
  const shapeData = shapeOptions.options[shape];
  if (!shapeData) {
    return;
  }
  return deepExtend2({
    close: shapeOptions.close,
    fill: shapeOptions.fill
  }, itemFromSingleOrMultiple2(shapeData, id, reduceDuplicates));
}
function fixOutMode2(data) {
  if (!isInArray2(data.outMode, data.checkModes)) {
    return;
  }
  const diameter = data.radius * double4;
  if (data.coord > data.maxCoord - diameter) {
    data.setCb(-data.radius);
  } else if (data.coord < diameter) {
    data.setCb(data.radius);
...
var Particle2 = class {
  constructor(engine, container) {
    this.container = container;
    this._calcPosition = (container2, position, zIndex, tryCount = defaultRetryCount2) => {
      for (const plugin of container2.plugins.values()) {
        const pluginPos = plugin.particlePosition !== void 0 ? plugin.particlePosition(position, this) : void 0;
        if (pluginPos) {
          return Vector3d2.create(pluginPos.x, pluginPos.y, zIndex);
        }
      }
      const canvasSize = container2.canvas.size, exactPosition = calcExactPositionOrRandomFromSize2({
        size: canvasSize,
        position
      }), pos = Vector3d2.create(exactPosition.x, exactPosition.y, zIndex), radius = this.getRadius(), outModes = this.options.move.outModes, fixHorizontal = (outMode) => {
        fixOutMode2({
          outMode,
          checkModes: [OutMode2.bounce],
          coord: pos.x,
          maxCoord: container2.canvas.size.width,
          setCb: (value) => pos.x += value,
          radius
      ...
      fixVertical(outModes.bottom ?? outModes.default);
      if (this._checkOverlap(pos, tryCount)) {
        return this._calcPosition(container2, void 0, zIndex, tryCount + tryCountIncrement2);
      }
      return pos;
    };
    this._calculateVelocity = () => {
      const baseVelocity = getParticleBaseVelocity2(this.direction), res = baseVelocity.copy(), moveOptions = this.options.move;
      if (moveOptions.direction === MoveDirection2.inside || moveOptions.direction === MoveDirection2.outside) {
        return res;
      }
      const rad = degToRad2(getRangeValue2(moveOptions.angle.value)), radOffset = degToRad2(getRangeValue2(moveOptions.angle.offset)), range = {
        left: radOffset - rad * half4,
        right: radOffset + rad * half4
      };
      if (!moveOptions.straight) {
        res.angle += randomInRange2(setRangeValue2(range.left, range.right));
      }
      if (moveOptions.random && typeof moveOptions.speed === "number") {
        res.length *= getRandom2();
      }
      return res;
    };
    this._checkOverlap = (pos, tryCount = defaultRetryCount2) => {
      const collisionsOptions = this.options.collisions, radius = this.getRadius();
      if (!collisionsOptions.enable) {
        return false;
      }
      ...
      const retries = overlapOptions.retries;
      if (retries >= minRetries2 && tryCount > retries) {
        throw new Error(`${errorPrefix2} particle is overlapping and can't be placed`);
      }
      return !!this.container.particles.find((particle) => getDistance2(pos, particle.position) < radius + particle.getRadius());
    };
    this._getRollColor = (color) => {
      if (!color || !this.roll || !this.backColor && !this.roll.alter) {
        return color;
      }
      const backFactor = this.roll.horizontal && this.roll.vertical ? double4 * rollFactor2 : rollFactor2, backSum = this.roll.horizontal ? Math.PI * half4 : none2, rolled = Math.floor(((this.roll.angle ?? none2) + backSum) / (Math.PI / backFactor)) % double4;
      if (!rolled) {
        return color;
      }
      if (this.backColor) {
      ...
      if (this.roll.alter) {
        return alterHsl2(color, this.roll.alter.type, this.roll.alter.value);
      }
      return color;
    };
    this._initPosition = (position) => {
      const container2 = this.container, zIndexValue = getRangeValue2(this.options.zIndex.value);
      this.position = this._calcPosition(container2, position, clamp2(zIndexValue, minZ2, container2.zLayers));
      this.initialPosition = this.position.copy();
      const canvasSize = container2.canvas.size;
      this.moveCenter = {
        ...getPosition2(this.options.move.center, canvasSize),
        radius: this.options.move.center.radius ?? defaultRadius2,
        mode: this.options.move.center.mode ?? PixelMode2.percent
      };
      this.direction = getParticleDirectionAngle2(this.options.move.direction, this.position, this.moveCenter);
      switch (this.options.move.direction) {
        case MoveDirection2.inside:
          this.outType = ParticleOutType2.inside;
          break;
        case MoveDirection2.outside:
          this.outType = ParticleOutType2.outside;
          break;
      }
  ...
  destroy(override) {
    ...
    pathGenerator == null ? void 0 : pathGenerator.reset(this);
    this._engine.dispatchEvent(EventType2.particleDestroyed, {
      container: this.container,
      data: {
        particle: this
      }
  ...
  getFillColor() {
    return this._getRollColor(this.bubble.color ?? getHslFromAnimation2(this.color));
  }
  getMass() {
    return this.getRadius() ** squareExp4 * Math.PI * half4;
  }
  getPosition() {
    return {
      x: this.position.x + this.offset.x,
  ...
  getStrokeColor() {
    return this._getRollColor(this.bubble.color ?? getHslFromAnimation2(this.strokeColor));
  }
  init(id, position, overrideOptions, group) {
    var _a, _b, _c, _d, _e, _f;
    const container = this.container, engine = this._engine;
    ...
    this.outType = ParticleOutType2.normal;
    this.ignoresResizeRatio = true;
    const pxRatio = container.retina.pixelRatio, mainOptions = container.actualOptions, particlesOptions = loadParticlesOptions2(this._engine, container, mainOptions.particles), { reduceDuplicates } = particlesOptions, effectType = particlesOptions.effect.type, shapeType = particlesOptions.shape.type;
    this.effect = itemFromSingleOrMultiple2(effectType, this.id, reduceDuplicates);
    this.shape = itemFromSingleOrMultiple2(shapeType, this.id, reduceDuplicates);
    const effectOptions = particlesOptions.effect, shapeOptions = particlesOptions.shape;
    if (overrideOptions) {
      if ((_a = overrideOptions.effect) == null ? void 0 : _a.type) {
        const overrideEffectType = overrideOptions.effect.type, effect = itemFromSingleOrMultiple2(overrideEffectType, this.id, reduceDuplicates);
        if (effect) {
          this.effect = effect;
          effectOptions.load(overrideOptions.effect);
        }
      ...
      if ((_b = overrideOptions.shape) == null ? void 0 : _b.type) {
        const overrideShapeType = overrideOptions.shape.type, shape = itemFromSingleOrMultiple2(overrideShapeType, this.id, reduceDuplicates);
        if (shape) {
          this.shape = shape;
          shapeOptions.load(overrideOptions.shape);
        }
    ...
    if (this.effect === randomColorValue2) {
      const availableEffects = [...this.container.effectDrawers.keys()];
      this.effect = availableEffects[Math.floor(Math.random() * availableEffects.length)];
    }
    if (this.shape === randomColorValue2) {
      const availableShapes = [...this.container.shapeDrawers.keys()];
      this.shape = availableShapes[Math.floor(Math.random() * availableShapes.length)];
    }
    this.effectData = loadEffectData2(this.effect, effectOptions, this.id, reduceDuplicates);
    this.shapeData = loadShapeData2(this.shape, shapeOptions, this.id, reduceDuplicates);
    particlesOptions.load(overrideOptions);
    const effectData = this.effectData;
    if (effectData) {
      particlesOptions.load(effectData.particles);
    ...
    const interactivity = new Interactivity2(engine, container);
    interactivity.load(container.actualOptions.interactivity);
    interactivity.load(particlesOptions.interactivity);
    this.interactivity = interactivity;
    this.effectFill = (effectData == null ? void 0 : effectData.fill) ?? particlesOptions.effect.fill;
    ...
    this.options = particlesOptions;
    const pathOptions = this.options.move.path;
    this.pathDelay = getRangeValue2(pathOptions.delay.value) * millisecondsToSeconds2;
    if (pathOptions.generator) {
      this.pathGenerator = this._engine.getPathGenerator(pathOptions.generator);
      if (this.pathGenerator && container.addPath(pathOptions.generator, this.pathGenerator)) {
        this.pathGenerator.init(container);
    ...
    container.retina.initParticle(this);
    this.size = initParticleNumericAnimationValue2(this.options.size, pxRatio);
    this.bubble = {
      inRange: false
    };
    this.slow = {
    ...
    this.initialVelocity = this._calculateVelocity();
    this.velocity = this.initialVelocity.copy();
    this.moveDecay = decayOffset2 - getRangeValue2(this.options.move.decay);
    const particles = container.particles;
    particles.setLastZIndex(this.position.z);
    this.zIndexFactor = this.position.z / container.zLayers;
    this.sides = 24;
    ...
    this.spawning = false;
    this.shadowColor = rangeColorToRgb2(this._engine, this.options.shadow.color);
    for (const updater of particles.updaters) {
      updater.init(this);
    }
    for (const mover of particles.movers) {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/Point.js
var Point2 = class {
  constructor(position, particle) {
    this.position = position;
    this.particle = particle;
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Types/RangeType.js
var RangeType2;
(function(RangeType3) {
  RangeType3["circle"] = "circle";
  RangeType3["rectangle"] = "rectangle";
})(RangeType2 || (RangeType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/Ranges.js
var BaseRange2 = class {
  constructor(x, y, type) {
    this.position = {
      x,
      y
...
var Circle2 = class _Circle extends BaseRange2 {
  constructor(x, y, radius) {
    super(x, y, RangeType2.circle);
    this.radius = radius;
  }
  contains(point) {
    return getDistance2(point, this.position) <= this.radius;
  }
  intersects(range) {
    const pos1 = this.position, pos2 = range.position, distPos = { x: Math.abs(pos2.x - pos1.x), y: Math.abs(pos2.y - pos1.y) }, r = this.radius;
    if (range instanceof _Circle || range.type === RangeType2.circle) {
      const circleRange = range, rSum = r + circleRange.radius, dist = Math.sqrt(distPos.x ** squareExp4 + distPos.y ** squareExp4);
      return rSum > dist;
    } else if (range instanceof Rectangle2 || range.type === RangeType2.rectangle) {
      const rectRange = range, { width, height } = rectRange.size, edges = Math.pow(distPos.x - width, squareExp4) + Math.pow(distPos.y - height, squareExp4);
      return edges <= r ** squareExp4 || distPos.x <= r + width && distPos.y <= r + height || distPos.x <= width || distPos.y <= height;
    }
    return false;
  }
};
var Rectangle2 = class _Rectangle extends BaseRange2 {
  constructor(x, y, width, height) {
    super(x, y, RangeType2.rectangle);
    this.size = {
      height,
      width
    };
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/QuadTree.js
var QuadTree2 = class _QuadTree {
  constructor(rectangle, capacity) {
    ...
    this._subdivide = () => {
      const { x, y } = this.rectangle.position, { width, height } = this.rectangle.size, { capacity: capacity2 } = this;
      for (let i = 0; i < subdivideCount2; i++) {
        const fixedIndex = i % double4;
        this._subs.push(new _QuadTree(new Rectangle2(x + width * half4 * fixedIndex, y + height * half4 * (Math.round(i * half4) - fixedIndex), width * half4, height * half4), capacity2));
      }
      this._divided = true;
    };
    this._points = [];
  ...
  query(range, check) {
    ...
    for (const p of this._points) {
      if (!range.contains(p.position) && getDistance2(range.position, p.position) > p.particle.getRadius() && (!check || check(p.particle))) {
        continue;
      }
      res.push(p.particle);
    }
  ...
  queryCircle(position, radius, check) {
    return this.query(new Circle2(position.x, position.y, radius), check);
  }
  queryRectangle(position, size, check) {
    return this.query(new Rectangle2(position.x, position.y, size.width, size.height), check);
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Particles.js
var qTreeRectangle2 = (canvasSize) => {
  const { height, width } = canvasSize;
  return new Rectangle2(posOffset2 * width, posOffset2 * height, sizeFactor2 * width, sizeFactor2 * height);
};
var Particles2 = class {
  constructor(engine, container) {
    ...
    this._applyDensity = (options, manualCount2, group) => {
      ...
      const densityFactor = this._initDensityFactor(numberOptions.density), optParticlesNumber = numberOptions.value, optParticlesLimit = numberOptions.limit.value > minLimit2 ? numberOptions.limit.value : optParticlesNumber, particlesNumber = Math.min(optParticlesNumber, optParticlesLimit) * densityFactor + manualCount2, particlesCount = Math.min(this.count, this.filter((t) => t.group === group).length);
      if (group === void 0) {
        this._limit = numberOptions.limit.value * densityFactor;
      } else {
        this._groupLimits.set(group, numberOptions.limit.value * densityFactor);
    ...
    this._pushParticle = (position, overrideOptions, group, initializer) => {
      try {
        let particle = this._pool.pop();
        if (!particle) {
          particle = new Particle2(this._engine, this._container);
        }
        particle.init(this._nextId, position, overrideOptions, group);
        let canAdd = true;
        if (initializer) {
        ...
        this._zArray.push(particle);
        this._nextId++;
        this._engine.dispatchEvent(EventType2.particleAdded, {
          container: this._container,
          data: {
            particle
          }
        ...
        getLogger2().warning(`${errorPrefix2} adding particle: ${e}`);
      }
    };
    this._removeParticle = (index, group, override) => {
      const particle = this._array[index];
      ...
      const zIdx = this._zArray.indexOf(particle);
      this._array.splice(index, deleteCount2);
      this._zArray.splice(zIdx, deleteCount2);
      particle.destroy(override);
      this._engine.dispatchEvent(EventType2.particleRemoved, {
        container: this._container,
        data: {
          particle
        }
    ...
    this._needsSort = false;
    this._lastZIndex = 0;
    this._interactionManager = new InteractionManager2(engine, container);
    this._pluginsInitialized = false;
    const canvasSize = container.canvas.size;
    this.quadTree = new QuadTree2(qTreeRectangle2(canvasSize), qTreeCapacity2);
    this.movers = [];
    this.updaters = [];
  }
  get count() {
  ...
  addManualParticles() {
    const container = this._container, options = container.actualOptions;
    options.manualParticles.forEach((p) => this.addParticle(p.position ? getPosition2(p.position, container.canvas.size) : void 0, p.options));
  }
  addParticle(position, overrideOptions, group, initializer) {
    const limitMode = this._container.actualOptions.particles.number.limit.mode, limit = group === void 0 ? this._limit : this._groupLimits.get(group) ?? this._limit, currentCount = this.count;
    if (limit > minLimit2) {
      switch (limitMode) {
        case LimitMode2.delete: {
          const countToRemove = currentCount + countOffset2 - limit;
          if (countToRemove > minCount2) {
            this.removeQuantity(countToRemove);
          }
          break;
        }
        case LimitMode2.wait:
          if (currentCount >= limit) {
            return;
          }
          break;
  ...
  removeAt(index, quantity = defaultRemoveQuantity2, group, override) {
    if (index < minIndex2 || index > this.count) {
      return;
    }
    let deleted = 0;
    for (let i = index; deleted < quantity && i < this.count; i++) {
  ...
  removeQuantity(quantity, group) {
    this.removeAt(minIndex2, quantity, group);
  }
  setDensity() {
  ...
  update(delta) {
    var _a, _b;
    const container = this._container, particlesToDelete = /* @__PURE__ */ new Set();
    this.quadTree = new QuadTree2(qTreeRectangle2(container.canvas.size), qTreeCapacity2);
    for (const pathGenerator of container.pathGenerators.values()) {
      pathGenerator.update();
    }
    for (const plugin of container.plugins.values()) {
    ...
    for (const particle of this._array) {
      ...
      this.quadTree.insert(new Point2(particle.getPosition(), particle));
    }
    if (particlesToDelete.size) {
      const checkDelete = (p) => !particlesToDelete.has(p);
      this._array = this.filter(checkDelete);
    ...
    if (this._needsSort) {
      const zArray = this._zArray;
      zArray.sort((a, b) => b.position.z - a.position.z || a.id - b.id);
      this._lastZIndex = zArray[zArray.length - lengthOffset2].position.z;
      this._needsSort = false;
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Retina.js
var Retina2 = class {
  constructor(container) {
    this.container = container;
    this.pixelRatio = defaultRatio2;
    this.reduceFactor = defaultReduceFactor2;
  }
  init() {
    const container = this.container, options = container.actualOptions;
    this.pixelRatio = !options.detectRetina || isSsr2() ? defaultRatio2 : window.devicePixelRatio;
    this.reduceFactor = defaultReduceFactor2;
    const ratio = this.pixelRatio, canvas = container.canvas;
    if (canvas.element) {
      const element = canvas.element;
    ...
    const particles = options.particles, moveOptions = particles.move;
    this.maxSpeed = getRangeValue2(moveOptions.gravity.maxSpeed) * ratio;
    this.sizeAnimationSpeed = getRangeValue2(particles.size.animation.speed) * ratio;
  }
  initParticle(particle) {
    const options = particle.options, ratio = this.pixelRatio, moveOptions = options.move, moveDistance = moveOptions.distance, props = particle.retina;
    props.moveDrift = getRangeValue2(moveOptions.drift) * ratio;
    props.moveSpeed = getRangeValue2(moveOptions.speed) * ratio;
    props.sizeAnimationSpeed = getRangeValue2(options.size.animation.speed) * ratio;
    const maxDistance = props.maxDistance;
    maxDistance.horizontal = moveDistance.horizontal !== void 0 ? moveDistance.horizontal * ratio : void 0;
    maxDistance.vertical = moveDistance.vertical !== void 0 ? moveDistance.vertical * ratio : void 0;
    props.maxSpeed = getRangeValue2(moveOptions.gravity.maxSpeed) * ratio;
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Container.js
function guardCheck2(container) {
  return container && !container.destroyed;
}
function initDelta2(value, fpsLimit = defaultFps2, smooth = false) {
  return {
    value,
    factor: smooth ? defaultFps2 / fpsLimit : defaultFps2 * value / millisecondsToSeconds2
  };
}
function loadContainerOptions2(engine, container, ...sourceOptionsArr) {
  const options = new Options2(engine, container);
  loadOptions2(options, ...sourceOptionsArr);
  return options;
}
var Container2 = class {
  constructor(engine, id, sourceOptions) {
    ...
    this._nextFrame = (timestamp) => {
      try {
        if (!this._smooth && this._lastFrameTime !== void 0 && timestamp < this._lastFrameTime + millisecondsToSeconds2 / this.fpsLimit) {
          this.draw(false);
          return;
        }
        this._lastFrameTime ?? (this._lastFrameTime = timestamp);
        const delta = initDelta2(timestamp - this._lastFrameTime, this.fpsLimit, this._smooth);
        this.addLifeTime(delta.value);
        this._lastFrameTime = timestamp;
        if (delta.value > millisecondsToSeconds2) {
          this.draw(false);
          return;
        }
        this.particles.draw(delta);
        ...
        getLogger2().error(`${errorPrefix2} in animation loop`, e);
      }
    };
    this._engine = engine;
    this.id = Symbol(id);
    ...
    this._sourceOptions = sourceOptions;
    this._initialSourceOptions = sourceOptions;
    this.retina = new Retina2(this);
    this.canvas = new Canvas2(this, this._engine);
    this.particles = new Particles2(this._engine, this);
    this.pathGenerators = /* @__PURE__ */ new Map();
    this.interactivity = {
      mouse: {
        clicking: false,
    ...
    this._eventListeners = new EventListeners2(this);
    this._intersectionObserver = safeIntersectionObserver2((entries) => this._intersectionManager(entries));
    this._engine.dispatchEvent(EventType2.containerBuilt, { container: this });
  }
  get animationStatus() {
  ...
  addClickHandler(callback) {
    ...
    const clickOrTouchHandler = (e, pos, radius) => {
      ...
      clickOrTouchHandler(e, pos, clickRadius2);
    }, touchStartHandler = () => {
      if (!guardCheck2(this)) {
        return;
      }
      ...
      if (touched && !touchMoved) {
        const touchEvent = e;
        let lastTouch = touchEvent.touches[touchEvent.touches.length - touchEndLengthOffset2];
        if (!lastTouch) {
          lastTouch = touchEvent.changedTouches[touchEvent.changedTouches.length - touchEndLengthOffset2];
          if (!lastTouch) {
            return;
          }
        }
        const element = this.canvas.element, canvasRect = element ? element.getBoundingClientRect() : void 0, pos = {
          x: lastTouch.clientX - (canvasRect ? canvasRect.left : minCoordinate2),
          y: lastTouch.clientY - (canvasRect ? canvasRect.top : minCoordinate2)
        };
        clickOrTouchHandler(e, pos, Math.max(lastTouch.radiusX, lastTouch.radiusY));
      }
      touched = false;
  ...
  destroy(remove = true) {
    ...
    if (remove) {
      const mainArr = this._engine.items, idx = mainArr.findIndex((t) => t === this);
      if (idx >= removeMinIndex2) {
        mainArr.splice(idx, removeDeleteCount2);
      }
    }
    this._engine.dispatchEvent(EventType2.containerDestroyed, { container: this });
  }
  draw(force) {
    if (!guardCheck2(this)) {
      return;
  ...
  async export(type, options = {}) {
    ...
    getLogger2().error(`${errorPrefix2} - Export plugin with type ${type} not found`);
  }
  handleClickMode(mode) {
    var _a;
    if (!guardCheck2(this)) {
  ...
  async init() {
    ...
    const { zLayers, duration, delay, fpsLimit, smooth } = this.actualOptions;
    this.zLayers = zLayers;
    this._duration = getRangeValue2(duration) * millisecondsToSeconds2;
    this._delay = getRangeValue2(delay) * millisecondsToSeconds2;
    this._lifeTime = 0;
    this.fpsLimit = fpsLimit > minFpsLimit2 ? fpsLimit : defaultFpsLimit2;
    this._smooth = smooth;
    for (const drawer of this.effectDrawers.values()) {
      await ((_a = drawer.init) == null ? void 0 : _a.call(drawer, this));
    }
    ...
    this._engine.dispatchEvent(EventType2.containerInit, { container: this });
    await this.particles.init();
    this.particles.setDensity();
    for (const plugin of this.plugins.values()) {
      (_d = plugin.particlesSetup) == null ? void 0 : _d.call(plugin);
    }
    this._engine.dispatchEvent(EventType2.particlesSetup, { container: this });
  }
  async loadTheme(name) {
    if (!guardCheck2(this)) {
      return;
  ...
  pause() {
    ...
    if (this._drawAnimationFrame !== void 0) {
      cancelAnimation2(this._drawAnimationFrame);
      delete this._drawAnimationFrame;
    }
    if (this._paused) {
      return;
    ...
    this._engine.dispatchEvent(EventType2.containerPaused, { container: this });
  }
  play(force) {
    if (!guardCheck2(this)) {
      return;
    ...
    this._engine.dispatchEvent(EventType2.containerPlay, { container: this });
    this.draw(needsUpdate ?? false);
  }
  async refresh() {
    if (!guardCheck2(this)) {
  ...
  async start() {
    ...
    await new Promise((resolve) => {
      const start = async () => {
        ...
        this._engine.dispatchEvent(EventType2.containerStarted, { container: this });
        this.play();
        resolve();
      };
      this._delayTimeout = setTimeout(() => void start(), this._delay);
  ...
  stop() {
    ...
    this._sourceOptions = this._options;
    this._engine.dispatchEvent(EventType2.containerStopped, { container: this });
  }
  updateActualOptions() {
    this.actualOptions.responsive = [];
    const newMaxWidth = this.actualOptions.setResponsive(this.canvas.size.width, this.retina.pixelRatio, this._options);
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Utils/EventDispatcher.js
var EventDispatcher2 = class {
  ...
  removeEventListener(type, listener) {
    ...
    if (length === deleteCount2) {
      this._listeners.delete(type);
    } else {
      arr.splice(idx, deleteCount2);
    }
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Engine.js
async function getItemsFromInitializer2(container, map, initializers, force = false) {
  let res = map.get(container);
  if (!res || force) {
    res = await Promise.all([...initializers.values()].map((t) => t(container)));
    map.set(container, res);
...
async function getDataFromUrl2(data) {
  const url = itemFromSingleOrMultiple2(data.url, data.index);
  if (!url) {
    return data.fallback;
  }
  const response = await fetch(url);
  ...
  getLogger2().error(`${errorPrefix2} ${response.status} while retrieving config file`);
  return data.fallback;
}
var getCanvasFromContainer2 = (domContainer) => {
  let canvasEl;
  if (domContainer instanceof HTMLCanvasElement || domContainer.tagName.toLowerCase() === canvasTag2) {
    canvasEl = domContainer;
    if (!canvasEl.dataset[generatedAttribute2]) {
      canvasEl.dataset[generatedAttribute2] = generatedFalse2;
    }
  } else {
    const existingCanvases = domContainer.getElementsByTagName(canvasTag2);
    if (existingCanvases.length) {
      canvasEl = existingCanvases[canvasFirstIndex2];
      canvasEl.dataset[generatedAttribute2] = generatedFalse2;
    } else {
      canvasEl = document.createElement(canvasTag2);
      canvasEl.dataset[generatedAttribute2] = generatedTrue2;
      domContainer.appendChild(canvasEl);
    }
  }
  const fullPercent = "100%";
...
var getDomContainer2 = (id, source) => {
  let domContainer = source ?? document.getElementById(id);
  if (domContainer) {
    return domContainer;
  }
  domContainer = document.createElement("div");
  domContainer.id = id;
  domContainer.dataset[generatedAttribute2] = generatedTrue2;
  document.body.append(domContainer);
  return domContainer;
};
var Engine2 = class {
  constructor() {
    this._configs = /* @__PURE__ */ new Map();
    this._domArray = [];
    this._eventDispatcher = new EventDispatcher2();
    this._initialized = false;
    this.plugins = [];
    this.colorManagers = /* @__PURE__ */ new Map();
    this.easingFunctions = /* @__PURE__ */ new Map();
  ...
  addConfig(config) {
    const key = config.key ?? config.name ?? "default";
    this._configs.set(key, config);
    this._eventDispatcher.dispatchEvent(EventType2.configAdded, { data: { name: key, config } });
  }
  async addEasing(name, easing, refresh = true) {
    if (this.getEasing(name)) {
      return;
  ...
  async addEffect(effect, drawer, refresh = true) {
    executeOnSingleOrMultiple2(effect, (type) => {
      if (!this.getEffectDrawer(type)) {
        this.effectDrawers.set(type, drawer);
      }
    });
  ...
  item(index) {
    const { items } = this, item = items[index];
    if (!item || item.destroyed) {
      items.splice(index, removeDeleteCount2);
      return;
    }
    return item;
  }
  async load(params) {
    var _a;
    const id = params.id ?? ((_a = params.element) == null ? void 0 : _a.id) ?? `tsparticles${Math.floor(getRandom2() * loadRandomFactor2)}`, { index, url } = params, options = url ? await getDataFromUrl2({ fallback: params.options, url, index }) : params.options;
    const currentOptions = itemFromSingleOrMultiple2(options, index), { items } = this, oldIndex = items.findIndex((v) => v.id.description === id), newItem = new Container2(this, id, currentOptions);
    if (oldIndex >= loadMinIndex2) {
      const old = this.item(oldIndex), deleteCount3 = old ? one2 : none2;
      if (old && !old.destroyed) {
        old.destroy(false);
      }
      items.splice(oldIndex, deleteCount3, newItem);
    ...
    const domContainer = getDomContainer2(id, params.element), canvasEl = getCanvasFromContainer2(domContainer);
    newItem.canvas.loadCanvas(canvasEl);
    await newItem.start();
    return newItem;
  }
  ...
  setOnClickHandler(callback) {
    const { items } = this;
    if (!items.length) {
      throw new Error(`${errorPrefix2} can only set click handlers after calling tsParticles.load()`);
    }
    items.forEach((item) => item.addClickHandler(callback));
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/init.js
function init2() {
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Core/Utils/ExternalInteractorBase.js
var ExternalInteractorBase2 = class {
  constructor(container) {
    this.type = InteractorType2.external;
    this.container = container;
  }
};

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Directions/RotateDirection.js
var RotateDirection2;
(function(RotateDirection3) {
  RotateDirection3["clockwise"] = "clockwise";
  RotateDirection3["counterClockwise"] = "counter-clockwise";
  RotateDirection3["random"] = "random";
})(RotateDirection2 || (RotateDirection2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/GradientType.js
var GradientType2;
(function(GradientType3) {
  GradientType3["linear"] = "linear";
  GradientType3["radial"] = "radial";
...
// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/Enums/Types/EasingType.js
var EasingType2;
(function(EasingType3) {
  EasingType3["easeInBack"] = "ease-in-back";
  EasingType3["easeInCirc"] = "ease-in-circ";
  ...
  EasingType3["easeInOutExpo"] = "ease-in-out-expo";
  EasingType3["easeInOutSine"] = "ease-in-out-sine";
})(EasingType2 || (EasingType2 = {}));

// node_modules/@tsparticles/interaction-external-trail/node_modules/@tsparticles/engine/browser/index.js
var tsParticles2 = init2();
if (!isSsr2()) {
...
var Trail = class {
  ...
  load(data) {
    ...
    if (data.particles !== void 0) {
      this.particles = deepExtend2({}, data.particles);
    }
...
var trailMode = "trail";
var TrailMaker = class extends ExternalInteractorBase2 {
  constructor(container) {
    super(container);
    this._delay = 0;
  }
  ...
  interact(delta) {
    ...
    const optDelay = trailOptions.delay * millisecondsToSeconds2 / this.container.retina.reduceFactor;
  ...
  isEnabled(particle) {
    ...
    return mouse.clicking && mouse.inside && !!mouse.position && isInArray2(trailMode, events.onClick.mode) || mouse.inside && !!mouse.position && isInArray2(trailMode, events.onHover.mode);
  }
...
function updateRoll(particle, delta) {
  ...
  const speed = data.speed * delta.factor, max = doublePI4;
  data.angle += speed;
  if (data.angle > max) {
    data.angle -= max;
  }
...
function applyDistance(particle) {
  ...
  if ((hasHDistance || hasVDistance) && !particle.misplaced) {
    ...
    if (hDistance) {
      particle.velocity.x = particle.velocity.y * half5 - particle.velocity.x;
    }
    if (vDistance) {
      particle.velocity.y = particle.velocity.x * half5 - particle.velocity.y;
    }
  } else if ((!hDistance || dxFixed < hDistance) && (!vDistance || dyFixed < vDistance) && particle.misplaced) {
    particle.misplaced = false;
  } else if (particle.misplaced) {
    const pos = particle.position, vel = particle.velocity;
    if (hDistance && (pos.x < initialPosition.x && vel.x < minVelocity4 || pos.x > initialPosition.x && vel.x > minVelocity4)) {
      vel.x *= -getRandom();
    }
    if (vDistance && (pos.y < initialPosition.y && vel.y < minVelocity4 || pos.y > initialPosition.y && vel.y > minVelocity4)) {
      vel.y *= -getRandom();
    }
  }
}
function move(particle, moveOptions, moveSpeed, maxSpeed, moveDrift, reduceFactor, delta) {
  ...
  const gravityOptions = particle.gravity, gravityFactor = (gravityOptions == null ? void 0 : gravityOptions.enable) && gravityOptions.inverse ? -identity3 : identity3;
  ...
  if ((gravityOptions == null ? void 0 : gravityOptions.enable) && maxSpeed > minVelocity4 && (!gravityOptions.inverse && velocity.y >= minVelocity4 && velocity.y >= maxSpeed || gravityOptions.inverse && velocity.y <= minVelocity4 && velocity.y <= -maxSpeed)) {
    velocity.y = gravityFactor * maxSpeed;
    if (moveSpeed) {
      particle.velocity.y = velocity.y / moveSpeed;
    }
  }
  const zIndexOptions = particle.options.zIndex, zVelocityFactor = (identity3 - particle.zIndexFactor) ** zIndexOptions.velocityRate;
...
function spin(particle, moveSpeed, reduceFactor) {
  ...
  const maxCanvasSize = Math.max(container.canvas.size.width, container.canvas.size.height), halfMaxSize = maxCanvasSize * half5;
  if (particle.spin.radius > halfMaxSize) {
    particle.spin.radius = halfMaxSize;
    particle.spin.acceleration *= -identity3;
  } else if (particle.spin.radius < minSpinRadius) {
    particle.spin.radius = minSpinRadius;
    particle.spin.acceleration *= -identity3;
  }
  particle.spin.angle += moveSpeed * spinFactor * (identity3 - particle.spin.radius / maxCanvasSize);
}
function applyPath(particle, delta) {
  ...
  if (pathOptions.clamp) {
    particle.velocity.x = clamp(particle.velocity.x, -identity3, identity3);
    particle.velocity.y = clamp(particle.velocity.y, -identity3, identity3);
  }
  particle.lastPathTime -= particle.pathDelay;
}
function getProximitySpeedFactor(particle) {
  return particle.slow.inRange ? particle.slow.factor : identity3;
}
function initSpin(particle) {
  ...
  particle.spin = {
    center: spinCenter,
    direction: particle.velocity.x >= minVelocity4 ? RotateDirection.clockwise : RotateDirection.counterClockwise,
...
var BaseMover = class {
  ...
  move(particle, delta) {
    ...
    const slowFactor = getProximitySpeedFactor(particle), reduceFactor = container.retina.reduceFactor, baseSpeed = particle.retina.moveSpeed, moveDrift = particle.retina.moveDrift, maxSize = getRangeMax(particleOptions.size.value) * pxRatio, sizeFactor3 = moveOptions.size ? particle.getRadius() / maxSize : defaultSizeFactor, deltaFactor = delta.factor || defaultDeltaFactor, moveSpeed = baseSpeed * sizeFactor3 * slowFactor * deltaFactor / diffFactor, maxSpeed = particle.retina.maxSpeed ?? container.retina.maxSpeed;
...
function bounceHorizontal(data) {
  ...
  let bounced = false;
  if (data.direction === OutModeDirection.right && data.bounds.right >= data.canvasSize.width && velocity > minVelocity5 || data.direction === OutModeDirection.left && data.bounds.left <= boundsMin && velocity < minVelocity5) {
...
function bounceVertical(data) {
  ...
  let bounced = false;
  if (data.direction === OutModeDirection.bottom && data.bounds.bottom >= data.canvasSize.height && velocity > minVelocity5 || data.direction === OutModeDirection.top && data.bounds.top <= boundsMin && velocity < minVelocity5) {
  ...
  update(particle, direction, _delta, outMode) {
    ...
    switch (particle.outType) {
      ...
      case ParticleOutType.inside: {
        ...
        if (vx < minVelocity6 && dx > particle.moveCenter.radius || vy < minVelocity6 && dy > particle.moveCenter.radius || vx >= minVelocity6 && dx < -particle.moveCenter.radius || vy >= minVelocity6 && dy < -particle.moveCenter.radius) {
          return;
        }
        break;
      }
...
var NoneOutMode = class {
  ...
  update(particle, direction, delta, outMode) {
    ...
    if (!gravityOptions.enable) {
      if (particle.velocity.y > minVelocity7 && particle.position.y <= canvasSize.height + pRadius || particle.velocity.y < minVelocity7 && particle.position.y >= -pRadius || particle.velocity.x > minVelocity7 && particle.position.x <= canvasSize.width + pRadius || particle.velocity.x < minVelocity7 && particle.position.x >= -pRadius) {
        return;
      }
  ...
  update(particle, direction, delta, outMode) {
    ...
    switch (particle.outType) {
      case ParticleOutType.inside: {
        ...
        if (vx <= minVelocity8 && dx >= minDistance || vy <= minVelocity8 && dy >= minDistance || vx >= minVelocity8 && dx <= minDistance || vy >= minVelocity8 && dy <= minDistance) {
          return;
        }
...
function drawEmoji(data, image) {
  const { context, opacity } = data, half14 = 0.5, previousAlpha = context.globalAlpha;
  if (!image) {
    return;
  }
  const diameter = image.width, radius = diameter * half14;
  context.globalAlpha = opacity;
...
var EmojiDrawer = class {
  ...
  particleInit(_container, particle) {
    const double20 = 2, shapeData = particle.shapeData;
    ...
    const padding = emojiOptions.padding * double20, maxSize = getRangeMax(particle.size.value), fullSize = maxSize + padding, canvasSize = fullSize * double20;
    let image;
    if (typeof OffscreenCanvas !== "undefined") {
      ...
      context.font = `400 ${maxSize * double20}px ${font}`;
...
function singleSelectorBounce(container, selector, div, bounceCb) {
  ...
  query.forEach((item) => {
    ...
    }, radius = elem.offsetWidth * half6 * pxRatio, tolerance = toleranceFactor * pxRatio, area = div.type === DivType.circle ? new Circle(pos.x, pos.y, radius + tolerance) : new Rectangle(elem.offsetLeft * pxRatio - tolerance, elem.offsetTop * pxRatio - tolerance, elem.offsetWidth * pxRatio + tolerance * double8, elem.offsetHeight * pxRatio + tolerance * double8);
  ...
  constructor(container, engine) {
    ...
    this._clickBubble = () => {
      ...
      for (const particle of query) {
        ...
        if (timeSpent > bubbleOptions.duration * double9) {
        ...
        const opacityData = {
          ...
          particlesObj: {
            ...
            value: ((_a = particle.opacity) == null ? void 0 : _a.value) ?? defaultOpacity3
          },
    ...
    this._hoverBubbleOpacity = (particle, ratio, divBubble) => {
      ...
      const optOpacity = particle.options.opacity.value, pOpacity = ((_b = particle.opacity) == null ? void 0 : _b.value) ?? defaultOpacity3, opacity = calculateBubbleValue(pOpacity, modeOpacity, getRangeMax(optOpacity), ratio);
      if (opacity !== void 0) {
    ...
    this._singleSelectorHover = (delta, selector, div) => {
      ...
      selectors.forEach((item) => {
        ...
        }, repulseRadius = elem.offsetWidth * half7 * pxRatio, area = div.type === DivType.circle ? new Circle(pos.x, pos.y, repulseRadius) : new Rectangle(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio), query = container2.particles.quadTree.query(area, (p) => this.isEnabled(p));
        for (const particle of query) {
          ...
          this._hoverBubbleSize(particle, defaultRatio3, divBubble);
          this._hoverBubbleOpacity(particle, defaultRatio3, divBubble);
          this._hoverBubbleColor(particle, defaultRatio3, divBubble);
        }
      });
    };
    this._engine = engine;
  ...
  constructor(engine, container) {
    ...
    this._singleSelectorRepulse = (selector, div) => {
      ...
      query.forEach((item) => {
        ...
        }, repulseRadius = elem.offsetWidth * half8 * pxRatio, area = div.type === DivType.circle ? new Circle(pos.x, pos.y, repulseRadius) : new Rectangle(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio), divs = repulse.divs, divRepulse = divMode(divs, elem);
...
function replaceImageColor(image, imageData, color, particle) {
  var _a;
  const svgColoredData = replaceColorSvg(image, color, ((_a = particle.opacity) == null ? void 0 : _a.value) ?? defaultOpacity4), imageRes = {
    color,
    gif: imageData.gif,
    data: {
      ...image,
...
var ByteStream = class {
  ...
  readSubBlocks() {
    ...
    const minCount3 = 0, emptySize = 0;
    do {
      size = this.data[this.pos++];
      for (let count = size; --count >= minCount3; blockString += String.fromCharCode(this.data[this.pos++])) {
      }
...
function drawGif(data) {
  ...
  const pos = { x: -image.gifData.width * half9, y: -image.gifData.height * half9 }, frame = image.gifData.frames[frameIndex];
    ...
    void (async () => {
      ...
      if (image.svgData && color) {
        ...
        imageRes = {
          ...
          loaded: true,
          ratio: imageData.width && imageData.height ? imageData.width / imageData.height : image.ratio ?? defaultRatio4,
          replaceColor,
          source: imageData.src
        };
      }
...
var LifeUpdater = class {
  ...
  init(particle) {
    ...
    particle.life = {
      delay: container.retina.reduceFactor ? getRangeValue(lifeOptions.delay.value) * (lifeOptions.delay.sync ? identity5 : getRandom()) / container.retina.reduceFactor * millisecondsToSeconds : noTime2,
      delayTime: noTime2,
      duration: container.retina.reduceFactor ? getRangeValue(lifeOptions.duration.value) * (lifeOptions.duration.sync ? identity5 : getRandom()) / container.retina.reduceFactor * millisecondsToSeconds : noTime2,
      time: noTime2,
...
var ParallaxMover = class {
  ...
  move(particle) {
    ...
    const canvasSize = container.canvas.size, canvasCenter = {
      x: canvasSize.width * half10,
      y: canvasSize.height * half10
...
var Attractor2 = class extends ParticlesInteractorBase {
  ...
  interact(p1) {
    ...
    for (const p2 of query) {
      ...
      const pos2 = p2.getPosition(), { dx, dy } = getDistances(pos1, pos2), rotate = p1.options.move.attract.rotate, ax = dx / (rotate.x * attractFactor), ay = dy / (rotate.y * attractFactor), p1Factor = p2.size.value / p1.size.value, p2Factor = identity6 / p1Factor;
...
var Collider = class extends ParticlesInteractorBase {
  ...
  interact(p1, delta) {
    ...
    const container = this.container, pos1 = p1.getPosition(), radius1 = p1.getRadius(), query = container.particles.quadTree.queryCircle(pos1, radius1 * double11);
    for (const p2 of query) {
...
var CircleWarp = class extends Circle {
  ...
  intersects(range) {
    ...
    if (circle.radius !== void 0) {
      const biggerCircle = new Circle(newPos.x, newPos.y, circle.radius * double12);
      return super.intersects(biggerCircle);
    } else if (rect.size !== void 0) {
      const rectSW = new Rectangle(newPos.x, newPos.y, rect.size.width * double12, rect.size.height * double12);
...
var LinkInstance = class {
  constructor(container, engine) {
    ...
    this._drawLinkTriangle = (p1, link1, link2) => {
      ...
      const container2 = this._container, options = container2.actualOptions, p2 = link1.destination, p3 = link2.destination, opacityTriangle = triangleOptions.opacity ?? (link1.opacity + link2.opacity) * half12;
    ...
    this._drawTriangles = (options, p1, link, p1Links) => {
      ...
      const vertices = (_c = p2.links) == null ? void 0 : _c.filter((t) => {
        const linkFreq = this._getLinkFrequency(p2, t.destination), minCount3 = 0;
        return p2.options.links && linkFreq <= p2.options.links.frequency && p1Links.findIndex((l) => l.destination === t.destination) >= minCount3;
      });
...
var TriangleDrawer = class extends PolygonDrawerBase {
  ...
  getSidesData(particle, radius) {
    const diameter = radius * double13;
    return {
      count: {
        denominator: 2,
        numerator: 3
...
var RotateUpdater = class {
  ...
  init(particle) {
    ...
    if (rotateDirection === RotateDirection.random) {
      const index = Math.floor(getRandom() * double14), minIndex3 = 0;
      rotateDirection = index > minIndex3 ? RotateDirection.counterClockwise : RotateDirection.clockwise;
    }
    ...
    if (rotateAnimation.enable) {
      particle.rotate.decay = identity7 - getRangeValue(rotateAnimation.decay);
...
function drawSquare(data) {
  const { context, radius } = data, fixedRadius = radius / fixFactor, fixedDiameter = fixedRadius * double15;
...
var StrokeColorUpdater = class {
  ...
  init(particle) {
    ...
    particle.strokeOpacity = getRangeValue(stroke.opacity ?? defaultOpacity5);
...
function drawText(data) {
  ...
  const text = particle.text, style = character.style ?? "", weight = character.weight ?? "400", size = Math.round(radius) * double16, font = character.font ?? "Verdana", fill = particle.shapeFill;
...
function drawLine3(context, line, radius, opacity, index, fill) {
  const offsetX = line.length * radius * half13, pos = {
    x: -offsetX,
    y: radius * half13
  }, diameter = radius * double16;
  if (fill) {
...
var TiltUpdater = class {
  ...
  init(particle) {
    ...
    particle.tilt = {
      ...
      sinDirection: getRandom() >= half ? identity8 : -identity8,
      cosDirection: getRandom() >= half ? identity8 : -identity8,
      min: 0,
      max: doublePI8
    };
    let tiltDirection = tiltOptions.direction;
    if (tiltDirection === TiltDirection.random) {
      const index = Math.floor(getRandom() * double17), minIndex3 = 0;
      tiltDirection = index > minIndex3 ? TiltDirection.counterClockwise : TiltDirection.clockwise;
    }
    ...
    if (tiltAnimation == null ? void 0 : tiltAnimation.enable) {
      particle.tilt.decay = identity8 - getRangeValue(tiltAnimation.decay);
...
function updateWobble(particle, delta) {
  ...
  const reduceFactor = container.retina.reduceFactor, angleSpeed = wobble.angleSpeed * delta.factor * reduceFactor, moveSpeed = wobble.moveSpeed * delta.factor * reduceFactor, distance = moveSpeed * (particle.retina.wobbleDistance ?? defaultDistance) / (millisecondsToSeconds / distanceFactor), max = doublePI9, { position } = particle;
...
var double19 = 2;
var doublePI10 = Math.PI * double19;
var maxAngle5 = 360;
